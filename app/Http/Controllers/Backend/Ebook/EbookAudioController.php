...
class EbookAudioController extends Controller
{
    ...
    {
        $data['ebookaudios'] = Ebook::where('type','ebookaudio')->orderBy('id', 'desc')->get();
        return view("Backend.ebookaudio.index",$data);
    }
    ...
    {
        $data['ebooks'] = Ebook::where('type','ebookaudio')->orderBy('id', 'desc')->get();
        ...
        return view("Backend.ebookaudio.create",$data);
    }
    ...
    public function store(Request $request)
    {
      // dd($request->all());
        ...
        try{
            ...
            DB::commit();
            return redirect()->route('admin.ebookaudio.index')->with('message','Ebook Audio Add Successfully');
        }catch(\Exception $e){
            DB::rollBack();
            dd($e);
    ...
    public function edit(string $id)
    {
       ...
       $data["sub_categories"] = Category::where('parent_id',$ebook->category_id)->orderBy('id', 'desc')->get();
        return view("Backend.ebookaudio.update",$data);
    }
    ...
    try{
        ...
        DB::commit();
        return redirect()->route('admin.ebookaudio.index')->with('message','Ebook Update Successfully');
    }catch(\Exception $e){
        DB::rollBack();
        dd($e);
        return back()->with ('error_message', $e->getMessage());
    ...
    public function destroy(Request $request)
    {
        ...
        $ebook->delete();
        return back()->with('message','Ebook Audio Deleted Successfully');
    }
    ...
    function changePassword(Request $request){
        ...
        $user->save();
        return redirect()->back()->with('message','Seller Profile Password Changed Successfully');
    }
    ...
    public function status($id)
    {
        ...
        $ebook->update();
        return redirect()->route('admin.ebookaudio.index');
    }
}
