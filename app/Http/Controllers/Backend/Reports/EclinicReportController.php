...
class EclinicReportController extends Controller
{
     function report(Request $request)
    {
       return view("Backend.reports.e_clinic");
    }
    function getClinicData(Request $request){
        $service =  Service::where('template',"e-clinic")->first();
       ...
       // $totalFiltered = ServiceBooking::where('service_id',$service->id)->count();
        ...
        foreach ($datas as $n_data)
        {
            ...
            $nestedData['clinic_name'] = $n_data->clinic?->name;
            $nestedData['clinic_mobile'] = $n_data->clinic?->mobile;
            $nestedData['clinic_email'] = $n_data->clinic?->email;
    ...
    function reportPackage(Request $request)
    {
       ...
       return view("Backend.reports.e_clinic_item");
    }
    function getClinicPackageData(Request $request){
        $service =  Service::where('template',"e-clinic")->first();
        ...
        foreach ($datas as $n_data)
        {
            ...
            $nestedData['clinic_name'] = $n_data->servicebooking->clinic?->name;
