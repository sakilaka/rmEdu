...
<head>
    ...
    <title>{{ env('APP_NAME') }} | Add Continent</title>
</head>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-9 m-auto grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <form class="forms-sample" action="{{ route('continent.store') }}" method="POST"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input id="continent_name" type="text" name="name"
                                                    class="form-control" placeholder="Enter Continent Name" required>
                                            </div>
                                        </div>
