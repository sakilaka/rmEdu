...
<head>
    ...
    <title>{{ env('APP_NAME') }} | Edit City</title>
</head>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-9 m-auto grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <form class="forms-sample" action="{{ route('city.update', ['id' => $city->id]) }}"
                                            ...
                                            <div class="col-sm-9">
                                                <div class="row">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="px-3">
                                                            <img src="{{ $city->image_show ?? asset('frontend/images/No-image.jpg') }}"
                                                                alt="" class="img-fluid"
                                            ...
                                            <div class="col-sm-9">
                                                <select id="continent" class="form-control form-control-lg"
                                                    ...
                                                    @foreach ($continents as $continent)
                                                        <option @if ($continent->id == $city->continent_id) Selected @endif
                                            ...
                                            <div class="col-sm-9">
                                                <select id="country" class="form-control form-control-lg"
                                                    ...
                                                    @foreach ($countries as $country)
                                                        <option @if ($country->id == $city->country_id) Selected @endif
                                            ...
                                            <div class="col-sm-9">
                                                <select id="state" class="form-control form-control-lg"
                                                    ...
                                                    @foreach ($states as $state)
                                                        <option @if ($state->id == $city->state_id) Selected @endif
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-3 d-flex justify-content-between align-items-center">
                                                <label for="state_name" class=" col-form-label">City Name
