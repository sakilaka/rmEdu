...
<head>
    ...
    <title>{{ env('APP_NAME') }} | Add City</title>
</head>
                                    ...
                                    <form class="forms-sample" action="{{ route('city.store') }}" method="POST"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-3 d-flex justify-content-between align-items-center">
                                                <label for="menu_type" class=" col-form-label">City Image</label>
                                                <p>:</p>
                                            </div>
                                            <div class="col-sm-9">
                                                <div class="row">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-3 d-flex justify-content-between align-items-center">
                                                <label for="category_type" class=" col-form-label">Continent</label>
                                                <p>:</p>
                                            </div>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-3 d-flex justify-content-between align-items-center">
                                                <label for="category_type" class=" col-form-label">Country</label>
                                                <p>:</p>
                                            </div>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-3 d-flex justify-content-between align-items-center">
                                                <label for="city_name" class=" col-form-label">City Name
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <p>:</p>
                                            </div>
                                            <div class="col-sm-9">
                                                <input id="city_name" type="text" name="name" class="form-control"
