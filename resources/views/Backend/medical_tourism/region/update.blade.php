    ...
    <div class="br-mainpanel">
        <div class="br-pageheader">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('region.index')}}"> <i class="icon ion-reply text-22"></i> All Continent</a>
          </nav>
        </div><!-- br-pageheader -->
                        ...
                        {{-- <div class="row mt-3" id="menuimage">
                            ...
                            <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                <div class="mt-1 mr-2" style="position:relative;box-shadow: 0px 0px 1px 1px;width: 150px;">
                                        <img class="display-upload-img" style="width: 150px;height: 70px;" src="{{ $region->image_show}}" alt="">
                          ...
                          <div class="row mt-4">
                            ...
                            <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                            <input type="text" name="name" value="{{ $region->name }}" class="form-control" placeholder="Enter Package Name" required>
                        </div>
                        </div><!-- row -->
