...
<head>
    ...
    <title>{{ env('APP_NAME') }} | All Country</title>
</head>
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="{{ route('country.create') }}" class="btn btn-primary btn-fw">
                                    ...
                                    @foreach ($countries as $item)
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="text-center">
                                                @if ($item->status == 1)
                                                    <a href="{{ route('country.toggle_status', $item->id) }}">
                        ...
                        <div class="modal-content">
                            <div class="modal-body text-center">
                                ...
                                <div class="m-t-20 flex">
                                    <form action="{{ route('country.delete') }}" method="POST" id="deleteForm">
                                        @csrf
