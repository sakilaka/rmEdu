                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="{{ route('state.create') }}" class="btn btn-primary btn-fw">
                                    ...
                                    @foreach ($states as $item)
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="text-center">
                                                @if ($item->status == 1)
                                                    <a href="{{ route('state.toggle_status', $item->id) }}">
                        ...
                        <div class="modal-content">
                            <div class="modal-body text-center">
                                ...
                                <div class="m-t-20 flex">
                                    <form action="{{ route('state.delete') }}" method="POST" id="deleteForm">
                                        @csrf
                                        <input type="hidden" name="state_id" id="modal_item_id" value="">
                                    </form>
                                    <div class="mt-3">
