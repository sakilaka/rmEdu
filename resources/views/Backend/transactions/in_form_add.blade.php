...
<head>
    ...
    <title>{{ env('APP_NAME') }} | In - Transaction</title>
</head>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="category"
                                                ...
                                                <option value="Student Payment"
                                                    {{ old('category') == 'Student Payment' ? 'selected' : '' }}>Student
                                                    Payment</option>
                                                <option value="Work Visa"
                                                    {{ old('category') == 'Work Visa' ? 'selected' : '' }}>Work Visa
                                                </option>
                                                <option value="Student Visa"
                                                    {{ old('category') == 'Student Visa' ? 'selected' : '' }}>Student
                                                    Visa</option>
                                                <option value="Ticketing"
                                                    {{ old('category') == 'Ticketing' ? 'selected' : '' }}>Ticketing
                                                </option>
                                                <option value="Tourist"
                                                    {{ old('category') == 'Tourist' ? 'selected' : '' }}>Tourist
                                                </option>
                                                <option value="Ranzee In"
                                                    {{ old('category') == 'Ranzee In' ? 'selected' : '' }}>Ranzee In
                                                </option>
                                                <option value="Rakin In"
                                                    {{ old('category') == 'Rakin In' ? 'selected' : '' }}>Rakin In
                                                </option>
