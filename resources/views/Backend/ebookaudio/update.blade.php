    ...
    <div class="br-mainpanel">
        <div class="br-pageheader">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('admin.ebookaudio.index')}}"> <i class="icon ion-reply text-22"></i> All Ebook</a>
          </nav>
        </div><!-- br-pageheader -->

        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center mb-4">Update Ebook Audio</h6>
             {{-- validate start  --}}
             @if(count($errors) > 0)
            ...
            <div class="col-xl-12 mx-auto">
                <div class="form-layout form-layout-4 py-5">
                    ...
                    <form action="{{ route('admin.ebookaudio.update', $ebook->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
