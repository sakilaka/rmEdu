    ...
    <div class="br-mainpanel">
        <div class="br-pageheader">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('phar-category.index')}}"> <i class="icon ion-reply text-22"></i> All Category</a>
          </nav>
        </div><!-- br-pageheader -->
          ...
          <div class="br-section-wrapper">
            ...
            <div class="col-xl-7 mx-auto">
                <div class="form-layout form-layout-4 py-5">
                    ...
                    <form action="{{ route('phar-category.update', $categorie->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        {{ method_field('PATCH') }}
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                <div class="mt-1 mr-2" style="position:relative;box-shadow: 0px 0px 1px 1px;width: 150px;">
                                        <img class="display-upload-img" style="width: 150px;height: 70px;" src="{{ $categorie->icon_show }}" alt="">
                        ...
                        <div class="row mt-3">
                            ...
                            <input style="padding: 4px;" type="color" id="color_code" name="" class="form-control" value="#{{ $categorie->color_code }}">
                            </div>
                            <div class="col-sm-5 mg-t-10 mg-sm-t-0">
                            <input style="padding: 4px;" type="text" name="color_code" id="show_color_code" class="form-control" value="{{ $categorie->color_code }}">
                            </div>
                        </div><!-- row -->
                        <div class="row mt-3">
                            <label class="col-sm-3 form-control-label">position : <span class="tx-danger">*</span></label>
                            <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                <input type="number" name="position" class="form-control" value="{{ $categorie->position}}">
                            </div>
                        </div><!-- row -->
