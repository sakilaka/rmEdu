...
<head>
    ...
    <title>{{ env('APP_NAME') }} | Edit Blog</title>
</head>
...
<body>
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="{{ route('blog.index') }}" class="btn btn-primary btn-fw">
                    ...
                    <div class="row">
                        <div class="col-md-12 m-auto grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <form class="forms-sample" action="{{ route('blog.update', $blog->id) }}"
                                        ...
                                        <div class="row mb-3">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="form-control-label">Blog Image<span
                                                                    class="text-danger"
                                                            ...
                                                            <div class="dropify-wrapper" style="border: none">
                                                                ...
                                                                <input type="file" class="dropify" name="image"
                                                                    accept="image/*" id="blog_image_upload">
                                                                <button type="button"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="px-3">
                                                            <img src="{{ $blog->image_show ?? asset('frontend/images/No-image.jpg') }}"
                                                                alt="" class="img-fluid"
                                            ...
                                            <div class="col-sm-12 col-md-8 col-lg-6">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="form-control-label">Author Image
                                                    ...
                                                    <div
                                                        class="col-sm-6 d-flex justify-content-center align-items-center">
                                                        <div class="px-3">
                                                            <img src="{{ $blog->author_image_show ?? asset('frontend/images/No-image.jpg') }}"
                                                                alt="" class="img-fluid"
                                                                style="border-radius: 10px" id="author_image_preview">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="text" name="title" class="form-control"
                                                            placeholder="Enter Headline" value="{{ $blog->title }}"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-control-label">Author Name:
                                                        <span class="text-danger"
                                                            style="font-size: 1.25rem; line-height:0;">*</span></label>
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control form-control-lg" name="topic_id">
                                                        ...
                                                        @foreach ($topics as $topic)
                                                            <option @if ($blog->topic->id == $topic->id) Selected @endif
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control form-control-lg" name="university_id">
                                                        ...
                                                        @foreach ($universities as $university)
                                                            <option @if ($university->id == $blog->university_id) Selected @endif
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="tag[]" class="form-control" id="tags"
                                                        value="{{ $tags }}">

                                                    <span class="text-muted">Separate multiple tags with comma ','</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" id="summernote" name="description" class="form-control" placeholder="Enter description"></textarea>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        $('#blog_image_upload').on('change', function(e) {
        ...
        $('#author_image_upload').on('change', function(e) {
            var fileInput = $(this)[0];
            ...
            if (fileInput.files && fileInput.files[0]) {
                ...
                reader.onload = function(e) {
                    $('#author_image_preview').attr('src', e.target.result);
                };
