                                            ...
                                            <div class="col-sm-9">
                                                <select id="cat" class="form-control form-control-lg"
                                                    ...
                                                    <option value="privacy-policy"
                                                        @if ($page->template == 'privacy-policy') selected @endif>Privacy Policy
                                                    </option>
                                                    <option value="refund-policy"
                                                        @if ($page->template == 'refund-policy') selected @endif>Refund and
                                                        Return Policy</option>
                                                    <option value="terms-conditions"
                                                        @if ($page->template == 'terms-conditions') selected @endif>Terms &
                                                        Conditions</option>
                                                </select>
                                            </div>
                                        </div>
