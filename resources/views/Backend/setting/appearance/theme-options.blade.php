...
<head>
    ...
    <title>{{ env('APP_NAME') }} | Theme Logo</title>
</head>
                        ...
                        <div class="col-10">
                            <div class="tab-content tab-content-vertical bg-white rounded">
                                <div class="tab-pane fade show active" id="program-info-tab-content" role="tabpanel"
                                    ...
                                    <form novalidate="" method="post" action="{{ route('backend.save-theme-logo') }}"
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="px-3">
                                                            <img src="{{ @$results->favicon == '' ? @$results->no_image : @$results->favicon_show ?? asset('frontend/images/No-image.jpg') }}"
                                                                alt="" class="img-fluid"
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row">
                                                    ...
                                                    <div
                                                        class="col-sm-6 d-flex justify-content-center align-items-center">
                                                        <div class="px-3">
                                                            <img src="{{ @$results->header_image == '' ? @$results->no_image : @$results->header_image_show ?? asset('frontend/images/No-image.jpg') }}"
                                                                alt="" class="img-fluid"
                                                                style="border-radius: 10px; max-height: 200px !important;"
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row">
                                                    ...
                                                    <div
                                                        class="col-sm-6 d-flex justify-content-center align-items-center">
                                                        <div class="px-3">
                                                            <img src="{{ @$results->footer_image == '' ? @$results->no_image : @$results->footer_image_show ?? asset('frontend/images/No-image.jpg') }}"
                                                                alt="" class="img-fluid"
                                                                style="border-radius: 10px; max-height: 200px !important;"
