    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center"> Care Giver Report</h6>
              ...
              <table id="report_datatalbe" class="table nowrap">
                <thead>
                  <tr>
                    ...
                    <th class="wd-25p">Care Giver Name</th>
                    <th class="wd-25p">Care Giver Phone</th>
                    <th class="wd-25p">Care Giver Email</th>
                    <th class="wd-25p">Customer Name</th>
                    <th class="wd-25p">Customer Phone</th>
                    <th class="wd-25p">Customer Email</th>
...
<script>
    var d_table= $('#report_datatalbe').DataTable({
        ...
        "ajax":{
            "url": "{{ route('get_care_giver_report') }}",
            "dataType": "json",
            "type": "POST",
        ...
        "columns": [
            ...
            { "data": "end_date" },
            { "data": "invoice" },
            { "data": "care_giver_name" },
            { "data": "care_giver_mobile" },
            { "data": "care_giver_email" },
            { "data": "cus_name" },
            { "data": "cus_mobile" },
            { "data": "cus_email" },
            { "data": "fee" },
