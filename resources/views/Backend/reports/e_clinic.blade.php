    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center"> E-clinic Service Report</h6>
              ...
              <table id="report_datatalbe" class="table nowrap">
                <thead>
                  <tr>
                    ...
                    <th class="wd-25p">E-clinic Name</th>
                    <th class="wd-25p">E-clinic Phone</th>
                    <th class="wd-25p">E-clinic Email</th>
