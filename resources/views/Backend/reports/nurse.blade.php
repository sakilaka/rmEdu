    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center"> Nurse Service Report</h6>
              ...
              <table id="report_datatalbe" class="table nowrap">
                <thead>
                  <tr>
                    ...
                    <th class="wd-25p">Nurse Name</th>
                    <th class="wd-25p">Nurse Phone</th>
                    <th class="wd-25p">Nurse Email</th>
