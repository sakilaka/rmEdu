    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center"> Therapy Service Report</h6>
              ...
              <table id="report_datatalbe" class="table nowrap">
                <thead>
                  <tr>
                    ...
                    <th class="wd-25p">Therapist Name</th>
                    <th class="wd-25p">Therapist Phone</th>
                    <th class="wd-25p">Therapist Email</th>
...
<script>
    var d_table= $('#report_datatalbe').DataTable({
        ...
        "ajax":{
            "url": "{{ route('get_therapist_report') }}",
            "dataType": "json",
            "type": "POST",
