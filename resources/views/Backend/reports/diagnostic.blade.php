    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center"> Diagnostic Service Report</h6>
              ...
              <table id="report_datatalbe" class="table nowrap">
                <thead>
                  <tr>
                    ...
                    <th class="wd-25p">Lab Name</th>
                    <th class="wd-25p">Lab Phone</th>
                    <th class="wd-25p">Lab Email</th>
...
<script>
    var d_table= $('#report_datatalbe').DataTable({
        ...
        "ajax":{
            "url": "{{ route('get_diagnostic_report') }}",
            "dataType": "json",
            "type": "POST",
