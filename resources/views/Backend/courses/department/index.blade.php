...
<head>
    ...
    <title>{{ env('APP_NAME') }} | All Department</title>
</head>
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="{{ route('admin.department.create') }}" class="btn btn-primary btn-fw">
                                    ...
                                    @foreach ($departments as $item)
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="text-center">
                                                @if ($item->status == 1)
                                                    <a href="{{ route('admin.department.status', $item->id) }}">
                        ...
                        <div class="modal-content">
                            <div class="modal-body text-center">
                                ...
                                <div class="m-t-20 flex">
                                    <form action="{{ route('admin.department.delete') }}" method="POST" id="deleteForm">
                                        @csrf
