...
<head>
    ...
    <title>{{ env('APP_NAME') }} | All Section</title>
</head>
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="{{ route('admin.section.create') }}" class="btn btn-primary btn-fw">
                                    ...
                                    @foreach ($sections as $item)
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="text-center">
                                                @if ($item->status == 1)
                                                    <a href="{{ route('admin.section.status', $item->id) }}">
                        ...
                        <div class="modal-content">
                            <div class="modal-body text-center">
                                ...
                                <div class="m-t-20 flex">
                                    <form action="{{ route('admin.section.delete') }}" method="POST" id="deleteForm">
                                        @csrf
