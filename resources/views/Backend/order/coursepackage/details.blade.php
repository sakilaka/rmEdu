          ...
          <div class="container mb-5 mt-3">
            <div class="row d-flex align-items-baseline">
              ...
              <div class="col-xl-3 float-end">
                <a  href="{{ route('admin.package.order_print',$orderdetails->id) }}" class="btn btn-light text-capitalize border-0" data-mdb-ripple-color="dark"><i
            ...
            <div class="container">
             ...
             <hr> --}}
            <form action="{{ route('package.status.change',$orderdetails->id) }}">
                @csrf
                <div class="col-sm-4 mt-3">
                    ...
                    <div class="mg-t-10 mg-sm-t-0">
                      <select class="form-control" name="status">
                        ...
                        <option @if ($orderdetails->status == "process") Selected @endif value="process">Process</option>
