...
<head>
    ...
    <title>{{ env('APP_NAME') }} | All Tesimonial</title>
</head>
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="{{ route('admin.add_new_testimonial') }}" class="btn btn-primary btn-fw">
                                    ...
                                    @foreach ($testimonials as $item)
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="text-center">
                                                @if ($item->status == 1)
                                                    <a href="{{ route('admin.status_testimonial', $item->id) }}">
                                            ...
                                            <td class="text-right">
                                                <a href="{{ route('admin.edit_testimonial', $item->id) }}"
