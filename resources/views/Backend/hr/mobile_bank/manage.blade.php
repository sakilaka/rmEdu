...
<div class="br-mainpanel">
          ...
          <div class="br-section-wrapper">
                ...
                <div class="text-center mb-4">
                    <h1 class="">Manage Mobile Bank </h1>
                    <br>
                </div>

              <input type="text" placeholder="Search Data" id="myInput">

              <a  class="btn btn-success btn-sm float-right text-light" data-toggle="modal" data-target="#addModal"><i class="fa fa-plus"></i></a>
              <a  class="btn btn-primary btn-sm float-right mx-2 text-light" href="{{route('manageBank')}}"> Bank</a>
              <a  class="btn btn-info btn-sm float-right mx-2 text-light" href="{{route('manageBranch')}}">Branch</a>
              <a  class="btn btn-secondary btn-sm float-right mx-2 text-light" href="{{route('manageInternetBank')}}">Internet Bank</a>
                      ...
                      @foreach ($viewAll as $i=>$data)
                        <tr>
                          ...
                          <td>
                              ...
                              <a href="/deleteMobileBank/{{ $data->id }}" style="color: #000">
  ...
  <div class="modal-dialog " role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#01303f;max-height: 50px;">
        <h5 class="modal-title" id="addModalLabel" style="color:white;line-height:18px;">Create Mobile Bank</h5>
            ...
            <div class="container-fluid">
                <div class="row row-card-one">
                    <div class="col-sm-12">
                        ...
                        <!-- form here -->
                        <form method="POST" action="{{route('storeMobileBank')}}">
                            @csrf
                            <div class="form-row">
...
<div class="modal fade" id="editModal_{{$p->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#01303f;max-height: 50px;">
        <h5 class="modal-title" id="addModalLabel" style="color:white;line-height:18px;">Update Mobile Bank</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true" style="color: white;line-height:18px;">×</span>
        </button>
        </div>
            ...
            <div class="container-fluid">
                <div class="row row-card-one">
                    <div class="col-sm-12">
                        ...
                        <!-- form here -->
                        <form method="POST" action="{{route('updateMobileBank',$p->id)}}">
                            @csrf
                            <div class="form-row">
