...
<div class="br-pagetitle p-1">
    <div class="br-section-wrapper p-2" style="z-index:100">
 <div class="">
   <div class="text-center ">
      <h2 class="text-center ">Edit Purchase</h2>
   </div>
              ...
              <div class="text-right">
                ...
                <form action="{{route('updatePurchase',$p->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row no-gutters">
                        <div class="col-md-2 my-2">
                            <label for=""><b>Company Name :</b> </label>
                           <input type="text" name="company_name" class="form-control" value="{{$p->company_name}}">
                           @error('company_name')
                         ...
                         <div class="col-md-2 my-2">
                           ...
                           <input type="text" name="company_employee_name" class="form-control"  value="{{$p->company_employee_name}}">
                         ...
                         <div class="col-md-2 my-2">
                           ...
                           <input type="text" name="company_phone"  class="form-control"  value="{{$p->company_phone}}">
                           @error('company_phone')
                           <span class="text-danger">{{$message}}</span>
                           @enderror
                        </div>
                        <div class="col-md-3 my-2">
                           ...
                           <input type="email" name="company_email"  class="form-control"  value="{{$p->company_email}}">
                           @error('company_email')
                           <span class="text-danger">{{$message}}</span>
                           @enderror
                        </div>
                         ...
                         <div class="col-md-3 my-2">
                            ...
                            <textarea name="company_address" id="" cols="30" rows="2" class="form-control"> {{$p->company_address}}
                            </textarea>
                       ...
                       <div class="col-md-3 my-2">
                           ...
                           <input type="text" name="product_name" placeholder="Product Name" class="form-control"  value="{{$p->product_name}}">
                           @error('product_name')
                           <span class="text-danger">{{$message}}</span>
                           @enderror
                        </div>
                          <div class="col-md-3 my-2">
                           ...
                           <select name="type" id="" class="form-control">
                            ...
                            <option value="physical" @if($p->type == 'physical') selected @endif>Physical</option>
                            <option value="virtual" @if($p->type == 'virtual') selected @endif >Virtual</option>
                           </select>
                           @error('type')
                           <span class="text-danger">{{$message}}</span>
                           @enderror
                        ...
                        <div class="col-md-3 my-2">
                           ...
                           <input type="text" name="sku" placeholder="SKU" class="form-control"  value="{{$p->sku}}">
                           @error('sku')
                           <span class="text-danger">{{$message}}</span>
                           @enderror
                        </div>
                        ...
                        <div class="col-md-3 my-2">
                           ...
                           <input type="date" name="duration"   class="form-control"  value="{{$p->duration}}">
                           @error('duration')
                           <span class="text-danger">{{$message}}</span>
                           @enderror
                        </div>
              ...
              <tbody id="dynamicField">
               ...
               <x-backend.purchase.update :id="$p->id"/>
                  ...
                  <button style="margin-top:35px!important" class="btn btn-sm btn-success mt-4" id="addNewField"><i class="fa fa-plus" ></i></button>
                        ...
                        <div class="col-md-3 my-2">
                           ...
                           <select name="payment" id="payment_type" class="form-control" >
                            ...
                            <option value="mobile" @if($payment->type == 'mobile') selected @endif>Mobile Banking</option>
                            <option value="internet"  @if($payment->type == 'internet') selected @endif>Internet Banking</option>
                            <option value="cheque"  @if($payment->type == 'cheque') selected @endif>Cheque</option>
                           </select>
                           @error('type')
                           <span class="text-danger">{{$message}}</span>
                           @enderror
                        </div>
                        <x-backend.purchase.payment :payment="$payment"/>

    	                <div class="col-md-3 my-2">
                            <label for=""> <b>Advance Amount:</b> </label>
                           <input type="number" name="advance" placeholder="Advance"  class="form-control"  value="{{$p->advance}}" id="advance" readonly>
                           @error('advance')
                           <span class="text-danger">{{$message}}</span>
                           @enderror
                        </div>
                        ...
                        <div class="col-md-3 my-2">
                           ...
                           <input type="number" name="pay" placeholder="Paid Amount"  class="form-control"  value="{{$p->pay}}" id="pay">
                           @error('pay')
                           <span class="text-danger">{{$message}}</span>
                           @enderror
                        </div>
                         ...
                         <div class="col-md-3 my-2">
                           ...
                           <input type="number" name="due" placeholder="Due"  class="form-control"  value="{{$p->due}}" id="due" readonly>
                           @error('due')
                           <span class="text-danger">{{$message}}</span>
                           @enderror
                        </div>
                        ...
                        <div class="col-md-3 my-2">
                           ...
                           <select name="status" id="" class="form-control">
                            ...
                            <option value="received" @if($p->status == 'received') selected @endif>Received</option>
                           </select>
                           @error('status')
                           <span class="text-danger">{{$message}}</span>
                           @enderror
                        ...
                        <div class="col-md-3 my-2">
                           ...
                           <input type="date" name="order_date"   class="form-control"  value="{{$p->order_date}}">
                           @error('pay')
                           <span class="text-danger">{{$message}}</span>
                           @enderror
                        </div>
                        ...
                        <label for=""> <b>Is Returnable? :</b> </label>
                           <input type="checkbox" name="is_return"   class="form--control"  value="1"      @if($p->is_return) checked @endif>
                           <!-- <label for="">Not Returnable</label>
                           <input type="checkbox" name=""   class="form--control"  value="1"> -->
                           @error('is_return')
                           <span class="text-danger">{{$message}}</span>
                           @enderror
