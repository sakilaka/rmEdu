                      ...
                      @foreach ($viewAll as $i=>$data)
                        <tr>
                          ...
                          <td>
                              ...
                              <a href="/deleteCategory/{{ $data->id }}" style="color: #000">
  ...
  <div class="modal-dialog " role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#01303f;max-height: 50px;">
        <h5 class="modal-title" id="addModalLabel" style="color:white;line-height:18px;">Create Quality</h5>
...
<div class="modal fade" id="editModal_{{$p->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#01303f;max-height: 50px;">
        <h5 class="modal-title" id="addModalLabel" style="color:white;line-height:18px;">Update Quality</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true" style="color: white;line-height:18px;">×</span>
        </button>
        </div>
            ...
            <div class="container-fluid">
                <div class="row row-card-one">
                    <div class="col-sm-12">
                        ...
                        <!-- form here -->
                        <form method="POST" action="{{route('updateCategory',$p->id)}}">
                            @csrf
                            <div class="form-row">
