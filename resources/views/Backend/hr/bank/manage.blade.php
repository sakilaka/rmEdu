...
<div class="br-mainpanel">
          ...
          <div class="br-section-wrapper">
              ...
              <a  class="btn btn-primary btn-sm float-right mx-2 text-light" href="{{route('manageInternetBank')}}">Internet Bank</a>
                  ...
                  <tbody id="dataTable" >
                      ...
                      @foreach ($viewAll as $i=>$data)
                        <tr>
                          ...
                          <td>
                              <a  class="btn text-info" data-toggle="modal" data-target="#editModal_{{$data->id}}"
                              >
                                  <i class="icon ion-compose tx-28"></i>
                              </a>
                              <a href="{{ url('deleteBank') }}/{{ $data->id }}" class="btn text-danger bg-white">
  ...
  <div class="modal-dialog " role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#01303f;max-height: 50px;">
        <h5 class="modal-title" id="addModalLabel" style="color:white;line-height:18px;">Create Bank</h5>
...
<div class="modal fade" id="editModal_{{$p->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#01303f;max-height: 50px;">
        <h5 class="modal-title" id="addModalLabel" style="color:white;line-height:18px;">Update Bank</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true" style="color: white;line-height:18px;">×</span>
        </button>
        </div>
            ...
            <div class="container-fluid">
                <div class="row row-card-one">
                    <div class="col-sm-12">
                        ...
                        <!-- form here -->
                        <form method="POST" action="{{route('updateBank',$p->id)}}">
                            @csrf
                            <div class="form-row">
