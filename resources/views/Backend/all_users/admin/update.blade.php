...
<head>
    ...
    <title>{{ env('APP_NAME') }} | Edit Admin</title>
</head>
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="{{ route('backend.manage_admin') }}" class="btn btn-primary btn-fw">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form class="forms-sample"
                                        action="{{ route('backend.update_admin', ['id' => $admin->id]) }}"
                                            ...
                                            <div class="col-sm-9">
                                                <div class="row">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="px-3">
                                                            <img src="{{ $admin->image_show ?? asset('frontend/images/No-image.jpg') }}"
                                                                alt="" class="img-fluid"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="name" class="form-control"
                                                    placeholder="Enter Admin Name" value="{{ $admin->name }}" required>
                                            </div>
                                        </div>
