...
<head>
    ...
    <title>{{ env('APP_NAME') }} | Add Founder or Co-Founder</title>
</head>
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="{{ route('admin.founder.index') }}" class="btn btn-primary btn-fw">
                    ...
                    <div class="row">
                        <div class="col-md-12 m-auto grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <form class="forms-sample" action="{{ route('admin.founder.store') }}"
