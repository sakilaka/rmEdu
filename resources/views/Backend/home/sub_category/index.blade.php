...
<head>
    ...
    <title>{{ env('APP_NAME') }} | All Sub Category</title>
</head>
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="{{ route('home-sub-category.create') }}" class="btn btn-primary btn-fw">
                                ...
                                <tbody>
                                    @foreach ($sub_categories as $item)
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <img src="{{ $item->image_show }}" alt="" width="60px"
                                                    height="40px">
                                            </td>
                                            <td>{{ $item->name }}</td>
                                            ...
                                            <td class="text-center">
                                                @if ($item->status == 1)
                                                    <a href="{{ route('home-sub-category.status_toggle',$item->id) }}">
                                            ...
                                            <td class="text-right">
                                                <a href="{{ route('home-sub-category.edit', $item->id) }}"
                        ...
                        <div class="modal-content">
                            <div class="modal-body text-center">
                                ...
                                <div class="m-t-20 flex">
                                    <form action="{{ route('home-sub-category.delete') }}" method="POST" id="deleteForm">
                                        @csrf
