                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="{{ route('frontend.manage_consultant_student') }}" class="btn btn-primary btn-fw">
                            ...
                            <div>
                                ...
                                <div class="row mt-4">
                                    <div class="col-sm-4">
                                        ...
                                        <div class="mt-1 mr-2">
                                            <img class="display-upload-img" style="width: 150px;height: auto; border-radius:8px;"
                    ...
                    <div class="d-flex justify-content-center my-3">
                        <a href="{{ route('frontend.manage_consultant_student') }}" class="btn btn-primary">Go Back</a>
                    </div>
                </div>
