...
@section('head')
    ...
    <link href="{{ asset('frontend') }}/application/modules/frontend/views/themes/default/assets/css/china_admission.css"
        rel="stylesheet">
    <style type="text/css">
        .social a {
                    ...
                    <div class="all_courses_container">
                        <div class="column p-0">
                            <div class="d-flex justify-content-between">
                                <p class="result-search">{{ $universities->total() }} Universities Found</p>
                                <div class="filters-button"></div>
                            </div>

                            <div class="wrapper-result-tags-and-sort">
                                <div class="tags searchingTags_wrapper mb-0">
                                    <a href="{{ route('frontend.university_course_list') }}" class="clear-filter" onclick="console.log('Clicked')">Clear</a>
                                </div>
                        ...
                        <div class="onSearchResultPage">
                            <div id="programsFoundCount" style="display:none">{{ $universities->count() }} Universities
                                Found
                            </div>
                                        ...
                                        <div class="column">
                                            <div class="d-flex justify-content-center" style="position: relative;">
                                                <div class="choice s-col-11 search-page-list-item">
                                                    <div class="choice-wrapper" data-url="{{ $university_details_url }}">

                                                        <div class="s-row">
                                                            <div class="s-col-9">
                                                                <a href="{{ $university_details_url }}" class="">
                                                                    <img style="margin-bottom:25px"
                                                                        src="{{ $university->image_show }}">
                                                                    <h4 class="title mb-1">
                                                                        <span class="mr-2"
                                                                            style="vertical-align: middle;">
                                                                            {{ strlen($university->name) > 50 ? substr($university->name, 0, 50) . '...' : $university->name }}
                                                                        </span>
                                                                    </h4>

                                                                    <p class="fw-bold">{{ $university->courses_count }} programs</p>
                                                                    ...
                                                                    <p class="school-name-desktop">
                                                                        ...
                                                                        <div class="tags">
                                                                            <span class="">
                                                                                ...
                                                                                {{ strlen($university->address ?? '') > 20 ? substr($university->address, 0, 20) . '...' : $university->address ?? '' }},
                                                                                {{ $university->continent->name }} ,
                                                                                {{ $university->country->name }} ,
                                                                            </span>
                                                                            <span>
                                                                                <i class="fa fa-comment"></i>
                                                                                {{ $university->language?->name }}
                                                                            </span>
                                                                        </div>
                                                                        ...
                                                                        <div class="wrapper-bullts">
                                                                            <div class="bulit">
                                                                                ...
                                                                                <div class="value">
                                                                                    {{ date('d M Y', strtotime($university->next_start_date)) }}
                                                                                </div>
                                                                            </div>
                                                                            <div class="bulit">
                                                                                <div class="title">Yearly Tuition</div>
                                                                                <div class="value"> <span
                                                                                        class="money">${{ format_price($university->year_fee) }}</span>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="bulit">
                                                                                ...
                                                                                <div class="value">
                                                                                    ...
                                                                                    {{ $university->course_duration }} Year
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="bulit">
                                                                        ...
                                                                        <div class="value text-danger"
                                                                            style="{{ strtotime($university->app_deadline) < strtotime(now()) ? 'text-decoration: line-through;' : '' }}">
                                                                            {{ date('d M Y', strtotime($university->app_deadline)) }}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                    ...
                                    <div class="column">
                                        <nav class="pagination" role="navigation" aria-label="pagination"
                                            ...
                                            <div class="pagination">
                                                <a page_no="{{ $universities->currentPage() == 1 ? 1 : $universities->currentPage() - 1 }}"
                                                ...
                                                @for ($i = 1; $i <= $universities->lastPage(); $i++)
                                                    <a class="pagination-link course-paginate page current @if ($i == $universities->currentPage()) is-current @endif"
                                                        page_no="{{ $i }}"
                                                        @if ($i == $universities->currentPage())  @endif
                                                        href="javascript:void(0)">{{ $i }}</a>
                                                @endfor

                                                <a page_no="{{ $universities->currentPage() == $universities->lastPage() ? $universities->lastPage() : $universities->currentPage() + 1 }}"
                                                    class="page-link course-paginate next_page next pagination-link"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function applyFilters() {
                ...
                $.ajax({
                    url: "{{ route('frontend.university_course_list') }}",
                    type: "GET",
                    data: {
                        degree: degree,
                        language: language,
        ...
        $(document).on('click', '.course-paginate', function(e) {
            ...
            $.ajax({
                url: "{{ route('frontend.university_course_list') }}?page=" + page,
                type: "GET",
                success: function(response) {
