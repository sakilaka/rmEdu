...
@section('main_content')
    ...
    <div style='background: #254991;' class='py-4'>
        <div class='container d-flex align-items-center justify-content-between'>
            <img src="{{ asset('/public/upload/users/' . auth()->user()->image) }}" width='60px' height='60px'
                class='rounded-pill border border-white'>
            <h4 class='text-white ' style='font-size: 25px;'>International Student
                Service System</h4>
            <a class='btn btn-danger btn-sm px-3' style='font-size: 14px;' href='{{ route('user.logout') }}'>Log out</a>
        </div>
    </div>
    <!-- end here new header -->
                    ...
                    <div class="d-none d-lg-block app-summary">
                        ...
                        <div class="app_summary">
                                ...
                                <div>
                                    <strong id="orig-app-fee"
                                        style="color: grey; text-decoration: line-through; display: none;"> $<span
                                            ...
                                            class="badge p-0">{{ $application->application_fee }}</span> USD</strong>
                                    <strong> $<span style="font-size: 1rem;color:black;" class="badge p-0"
                                            id="application-fee">{{ $application->application_fee }}</span> USD</strong>
                                </div>
                            </div>
                            ...
                            <div class="mt-2 mb2 total-fee d-flex justify-content-between"><span class=""> Total
                                    Fee</span>
                                <strong>$<span style="font-size: 1rem;color:black;" class="badge p-0"
                                        id="total-fee">{{ $application->total_fee }}</span> USD</strong>
                            </div>
                            <hr>
                        </div>
                                ...
                                <div class=" d-md-flex item p-4" id="prog-250787">
                                    <div style="position: absolute;right: 5px;z-index: 999;top: -5px;">
                                        <div class="delete-container">
                                            <button type="button" title="Delete program" data-code="{{ $cart->id }}"
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="d-md-flex flex-column justify-content-between mainContentArea">
                                            <div class="">
                                                <a href="{{ url('courses/details/' . $cart->course?->id) }}" class="title"
                                                ...
                                                <div class="status">
                                                    <div class="d-flex justify-content-between">Deadline:
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <strong
                                                                ...
                                                                {{ date('M d, Y', strtotime($cart->course?->application_deadline)) }}
                                                            </strong>
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        Start:<strong>
                                                            {{ date('M d, Y', strtotime($cart->course?->next_start_date)) }}
                                                        </strong>
                                                    </div>
                                                </div>
                                            ...
                                            <form action="" id="aboutyou" enctype="multipart/form-data">
                                                ...
                                                <div class="multisteps-form__content">
                                                    <div class="form-row ">
                                                        <div class="col-12 col-sm-6">
                                                            <div class=" form-label-group mt-2">
                                                                ...
                                                                <input type="text" id="first_name" name="first_name"
                                                                    ...
                                                                    value="{{ auth()->user()->name ?? $application->first_name }}">
                                                        ...
                                                        <!--            <option-->
                                                        <!--                @if ($application->in_alcoholic == 0)
    selected
    @endif-->
                                                        <!--                value="false">No</option>-->
                                                        <!--            <option-->
                                                        <!--                @if ($application->in_alcoholic == 1)
    selected
    @endif-->
                                                        ...
                                                        <div class="col-12 mt-2">
                                                            <div class=" form-label-group mt-2">
                                                                ...
                                                                <input type="text" id="language_native"
                                                                    ...
                                                                    maxlength=""
                                                                    value="{{ $application->native_language }}">
                                                        ...
                                                        <div class="col-12 mt-2">
                                                            <div class="form-label-group mt-2">
                                                                <select class="custom-select d-block w-100"
                                                                    ...
                                                                    <option
                                                                        @if ($application->english_level == 5) selected @endif
                                                                        value="5">5 - TOEIC</option>
                                                                    <option
                                                                        @if ($application->english_level == 6) selected @endif
                                                                        value="6">6 - PTE</option>
                                                                    <option
                                                                        @if ($application->english_level == 7) selected @endif
                                                                        value="7">7 - Native Language</option>
                                                                    <option
                                                                        @if ($application->english_level == 8) selected @endif
                                                                        value="8">8 - PTE</option>
                                                                    <option
                                                                        @if ($application->english_level == 9) selected @endif
                                                            ...
                                                            <div class="form-group mt-3" id="otherEnglishLevel"
                                                                ...
                                                                <input type="text" id="other_english_level"
                                                                    ...
                                                                    value="{{ old('other_english_level', $application->other_english_level ?? '') }}">
                                                            </div>
                                                        ...
                                                        <div class="form-row ">
                                                            ...
                                                            <div class="col-12 col-sm-6">
                                                                <div class=" form-label-group mt-2">
                                                                    ...
                                                                    @foreach ($countries as $country)
                                                                        <option
                                                                            @if ($country->id == $application->home_country) selected @endif
                                                                            value="{{ $country->id }}">
                                                                            {{ $country->name }}</option>
                                                                    @endforeach
                                                                </select>
                                                        ...
                                                        <div class="form-row ">
                                                            ...
                                                            <div class="col-12 col-sm-6">
                                                                <div class=" form-label-group mt-2">
                                                                    ...
                                                                    @foreach ($countries as $country)
                                                                        <option
                                                                            @if ($country->id == $application->current_country) selected @endif
                                                                            value="{{ $country->id }}">
                                                                            {{ $country->name }}</option>
                                                                    @endforeach
                                                                </select>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    {{-- <button type="button" class="close close-delete-program-modal" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button> --}}
                </div>
...
@section('cus_sc')
    ...
    {{-- <script src="{{ asset('frontend') }}/application/modules/frontend/views/themes/default/assets/js/j_query.js"></script> --}}
