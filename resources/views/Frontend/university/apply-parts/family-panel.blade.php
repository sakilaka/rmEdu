                ...
                <div class="form-row ">
                    ...
                    <div class="col-12 col-sm-6">
                        <div class=" form-label-group mt-2">
                            ...
                            <input type="date" id="date_of_birth" name="family_member_work_date_of_birth" data-name="date_of_birth" required="" placeholder="Date of birth" class="form-control" maxlength="" value="{{ $application->father_position }}">
                ...
                <div class="form-row ">
                    ...
                    <div class="col-12 col-sm-6">
                        <div class=" form-label-group mt-2">
                            ...
                            <input type="date" id="date_of_birth" name="date_of_birth" data-name="date_of_birth" required="" placeholder="Date of birth" class="form-control" maxlength="" value="{{ $application->father_position }}">
                            <label for="date_of_birth" class="form-control-placeholder">
                                Date of birth</label>
