                ...
                <div class="single-course-wrap">
                    ...
                    <div class="content-area">
                        ...
                        <div class="course-footer">
                            ...
                            <div class="cl-button">
                                <a href="{{ $apply_url }}" class="btn-details btn-link btn-tertiary-bg">Apply
                                    Now
...
<script>
    $(document).ready(function() {
        ...
        $('#degreeFilter').change(function() {
            ...
            const universityId =
                "{{ @$university->id }}"; // Get the university ID from the Blade template
            console.log('University ID:', universityId); // Debugging

            // Send an AJAX request to fetch filtered courses
            $.ajax({
                url: "{{ route('filter_courses') }}", // Route for filtering courses
                type: "GET",
                data: {
                    degree: degree,
