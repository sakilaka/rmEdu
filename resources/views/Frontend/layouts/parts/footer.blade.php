...
<footer style="background-color: var(--footer_news_color); color:white !important;">
    <div class="container pt-5" style="{{ Route::is('frontend.course.details') ? 'padding: 0 1.65rem !important' : '' }}">
        <div class="row mx-0 py-3">
            {{-- <div class="col-12 col-lg-4">
                <div class="d-flex align-items-center">
                    <img src="{{ $footer_logo->footer_image_show }}" class="img-fluid " style="height: 100px; width:160px"
                        alt="">
                </div>
                <div class="mt-4">
                    <p class="text footer_description">
                        @if (@$footer_contents->description > 0)
                            {{ @$footer_contents->description }}
                        @endif
                    </p>
                </div>

                <div class="d-flex justify-content-between-align-items-center mt-5">
                    <img src="{{ asset('frontend/images/google-play-button.jpg') }}" width="145" height="45"
                        style="border-radius: 8px" alt="">
                    <img src="{{ asset('frontend/images/app-store-button.jpg') }}" width="145" height="45"
            ...
            <div class="col-6 col-lg-4 ml-lg-4 mt-4 mt-lg-0">
                ...
                <ul class="nav-list list-unstyled mt-4 mb-0">
                    @foreach ($menus_ss as $menu_2)
                        <li>
                            <a href="{{ url($menu_2->url) }}"
                                class="text-decoration-none mb-2 text d-inline-block">{{ $menu_2->name }}</a>
                        </li>
                    @endforeach
            ...
            <div class="col-12 col-lg-4 mt-4 mt-lg-0">
                ...
                <div class="mt-3">
                    @if (@$footer_contents->phone1 > 0)
                        <a href="mailto:{{ @$footer_contents->phone1 }}" class="text"
                            style="margin-bottom: 10px; line-height:0.85;">
                            <i class="fa fa-phone" style="font-size: 0.9rem; margin-right:5px"></i>
                            {{ @$footer_contents->phone1 }}
                        </a>
                    @endif
                    <br>
                    @if (@$footer_contents->phone2 > 0)
                        <a href="mailto:{{ @$footer_contents->phone2 }}" class="text"
                            style="margin-bottom: 10px; line-height:0.85;">
                            <i class="fa fa-phone" style="font-size: 0.9rem; margin-right:5px"></i>
                            {{ @$footer_contents->phone2 }}
                        </a>
                    @endif
                </div>
                ...
                <div class="d-lg-flex justify-content-lg-end align-items-lg-center">
                    <div style="margin-right: 3rem">
                        <p class="text text-center py-3 mb-0">
                            &copy; {{ date('Y') }} <a href="#" class="text">{{ env('APP_NAME') }}</a>.
                            All
                            Rights Reserved
                        </p>
                    </div>
                    <div class="d-flex justify-content-around">
                        <div style="margin-right: 18px">
                            <a href="{{ route('frontend.terms_conditions') }}" class="text text-center py-3 mb-0">
                                <span style="line-height: 0">
                                    <i class="fa fa-circle" aria-hidden="true" style="font-size: 10px"></i>
                                </span>
                        ...
                        <div style="margin-right: 18px">
                            <a href="{{ route('frontend.privacy_policy') }}" class="text text-center py-3 mb-0">
                                <span style="line-height: 0">
                                    <i class="fa fa-circle" aria-hidden="true" style="font-size: 10px"></i>
                                </span>
                                <span style="margin-left: 1px">
                        ...
                        <div>
                            <a href="{{ route('frontend.refund_policy') }}" class="text text-center py-3 mb-0">
                                <span style="line-height: 0">
                                    <i class="fa fa-circle" aria-hidden="true" style="font-size: 10px"></i>
                                </span>
                                <span style="margin-left: 1px">
