...
<section class="position-relative overflow-hidden w-100" style="margin-top:3rem; width: 100% !important;">
    <div class="banner-section-container slick-slider">
        <div class="row mx-0 mt-md-5">
            <div class="col-12 px-0 position-relative">
                <div class="image-container d-flex justify-content-start align-items-center"
                    style="background-image: url({{ asset('upload/home_content/hero_slider/' . $home_content->hero_slider_bg_1) }}); background-size:cover;">
                    <div class="container px-0">
                        <div class="row mx-0">
                            <div class="col-12 col-md-8 col-lg-6">
                                <div>
                                    <h2 class="banner-text">
                                        {{ $home_content->hero_slider_title_1 }}
                                    </h2>
                                </div>
                                <div
                                    ...
                                    <a href="{{ $heroSliderBtnText1->hero_slider_btn_url_1_first }}"
                                        class="btn btn-primary-bg banner-btn">
                                        {{ $heroSliderBtnText1->hero_slider_btn_text_1_first }}
                                    ...
                                    <a href="{{ $heroSliderBtnText1->hero_slider_btn_url_1_second }}"
                                        class="btn btn-tertiary-bg banner-btn mt-2 mt-md-0">
                                        {{ $heroSliderBtnText1->hero_slider_btn_text_1_second }}
                                        <svg class="ms-2" xmlns="http://www.w3.org/2000/svg" width="28.56"
                                            height="15.666" viewBox="0 0 28.56 15.666">
                                            <path id="right-arrow_3_" data-name="right-arrow (3)"
                                                d="M20.727,107.5l-1.272,1.272,5.661,5.661H0v1.8H25.116l-5.661,5.661,1.272,1.272,7.833-7.833Z"
        ...
        <div class="row mx-0 mt-md-5">
            <div class="col-12 px-0 position-relative">
                <div class="image-container d-flex justify-content-start align-items-center"
                    style="background-image: url({{ asset('upload/home_content/hero_slider/' . $home_content->hero_slider_bg_2) }}); background-size:cover;">
                    <div class="container px-0">
                        <div class="row mx-0">
                            <div class="col-12 col-md-8 col-lg-6">
                                <div>
                                    <h2 class="banner-text">
                                        {{ $home_content->hero_slider_title_2 }}
                                    </h2>
                                </div>
                                <div
                                    class="d-md-flex justify-content-md-start align-items-md-center banner-btn-container">
                                    ...
                                    <a href="{{ $heroSliderBtnText2->hero_slider_btn_url_2_first }}"
                                        class="btn btn-primary-bg banner-btn">
                                        {{ $heroSliderBtnText2->hero_slider_btn_text_2_first }}
                                        <svg class="ms-2" xmlns="http://www.w3.org/2000/svg" width="28.56"
                                            height="15.666" viewBox="0 0 28.56 15.666">
                                            <path id="right-arrow_3_" data-name="right-arrow (3)"
                                                d="M20.727,107.5l-1.272,1.272,5.661,5.661H0v1.8H25.116l-5.661,5.661,1.272,1.272,7.833-7.833Z"
                                    ...
                                    <a href="{{ $heroSliderBtnText2->hero_slider_btn_url_2_second }}"
                                        class="btn btn-tertiary-bg banner-btn mt-2 mt-md-0">
                                        {{ $heroSliderBtnText2->hero_slider_btn_text_2_second }}
                                        <svg class="ms-2" xmlns="http://www.w3.org/2000/svg" width="28.56"
                                            height="15.666" viewBox="0 0 28.56 15.666">
                                            <path id="right-arrow_3_" data-name="right-arrow (3)"
                                                d="M20.727,107.5l-1.272,1.272,5.661,5.661H0v1.8H25.116l-5.661,5.661,1.272,1.272,7.833-7.833Z"
            ...
            <div class="row justify-content-center col-12 col-lg-7 py-4 bg-light m-auto filtering_box">
                <div class="col-12 col-lg-4 mt-2 mt-lg-0 col-padding-right">
                    <div class="{{-- form-floating --}}">
                        <select class="form-control select2_form_select" {{-- aria-label="Floating label select example" --}} name="country">
