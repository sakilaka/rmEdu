...
<head>
    ...
    <style>
        ...
        #required-attachments {
            overflow-x: auto;
            /* Enables horizontal scroll if content overflows */
            white-space: nowrap;
            /* Prevents the list items from wrapping to the next line */
        }
        ...
        ul li {
            ...
            margin-right: 10px;
            /* Adjust spacing between filenames */
        }
    </style>
    ...
    @if ($dataObj)
        <style>
            ...
            :root {
                ...
                --header_banner_bg: {{ $dataObj->header_banner_bg ?? '#102f25' }};
                ...
                --button2_hover_border_color: {{ $dataObj->button2_hover_border_color ?? '#102f25' }};
...
<body>
    ...
    <script src="{{ asset('frontend/application/modules/frontend/views/themes/default/assets/js/sweetalert.min.js') }}">
    </script>
    ...
    {{-- //card remove start --}}
    <script src="{{ asset('frontend/application/modules/frontend/views/themes/default/assets/js/axios.min.js') }}">
    </script>
    ...
    <script src="{{ asset('frontend/application/modules/frontend/views/themes/default/assets/js/umd-popper.min.js') }}">
    </script>
    <script src="{{ asset('frontend/application/modules/frontend/views/themes/default/assets/js/tippy-umd.min.js') }}">
    </script>
    <script
    ...
    <script src="http://translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script> --}}
        ...
        <script src="{{ asset('translate/js/gt.min.js') }}" data-gt-widget-id="43217984"></script>
        {{-- Multilanguage end  --}}
