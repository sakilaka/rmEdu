                                    ...
                                    <Form>
                                        <div class="input-group course-search">
                                            <input type="text" class="bg-white form-control pe-5 box"
                                                placeholder="Search For Event" name="name" value="{{ $name }}"
                        ...
                        <div class="row g-3 event_cat_ajax-show show-events-data event_relese_ajax-show">
                            ...
                            @foreach ($events as $event)
                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                                    ...
                                    <div class="course-card rounded-3 bg-white position-relative overflow-hidden">
                                        <div class="position-relative">
                                            ...
                                            <a href="{{ route('frontend.event.details', $event->id) }}" class="">
                                                <img src="{{ $event->image_show ?? '' }}" class="img-fluid w-100 imgdiv"
                                            ...
                                            <div class="end-0 p-2 position-absolute start-0 top-1">
                                                ...
                                                <a href="{{ route('frontend.event.details', $event->id) }}"
                                                    class="btn btn-dark fw-semi-bold mb-1"
                                                    style="color: var(--product_text_color)">{{ $event->name }}</a> --}}
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <h3 class="course-card__course--title text-uppercase fs-6 mb-3">
                                                    <a href="{{ route('frontend.event.details', $event->id) }}"
                                                        ...
                                                        style="color: var(--primary_background)">{{ $event->name }}</a>
                                                </h3>
                                                <!--End Course Title-->
                                                <!--Start Course Hints-->
                                    ...
                                    <h5> Event Fee: <b>${{ format_price(@$event->fee) }}</b></h5>
...
@section('script')
    ...
    <script>
        ...
        $(".on_click_eventrelease").change(function(e) {
            ...
            $.ajax({
                type: 'GET',
                url: "{{ url('event-relese-show-ajax') }}/" + id + "?cat_id=" + cat_id + '&search=' +
                    s_val,
