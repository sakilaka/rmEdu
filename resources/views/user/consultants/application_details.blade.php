            ...
            <table border="1" class="col-md-12">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"> <p>{{ @$item->major }}</p></td>
                        <td class="text-center"><p>{{ $item->gpa_type }} </p></td>
                        <td class="text-center"><p>{{ date('d-m-Y',strtotime(@$item->start_date)) }}</p></td>
                                        <td class="text-center"><p>{{ date('d-m-Y',strtotime(@$item->end_date)) }}</p></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
            ...
            <table border="1" class="col-md-12">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"> <p>{{ @$item->job_title }}</p></td>
                        <td class="text-center"><p>{{ date('d-m-Y',strtotime(@$item->start_date)) }}</p></td>
                        <td class="text-center"><p>{{ date('d-m-Y',strtotime(@$item->end_date)) }}</p></td>
                    </tr>
                    @endforeach
