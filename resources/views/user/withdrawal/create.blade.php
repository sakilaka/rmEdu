...
<form action="{{ route('frontend.stor_withdrawal') }}" method="post">
    @csrf
<div class="card card-body shadow">
                <div class="col-md-12">
                    <label class="mb-2">Amount($) <span style="color: red" >*</span></label>
                    <input type="text" class="form-control  mb-2 "  name="amount"  placeholder="Enter Amount" required/>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <select class="form-select form-control" name="payment_method" required>
                        ...
                        <option value="0"> Bank Transaction </option>
                ...
                <div class="col-md-12 mt-3">
                    ...
                    <textarea type="text" class="form-control  mb-2 " name="note"  placeholder="You can add a note, if you have!"></textarea>
                </div>
                <div class="col-md-12 mt-3">
