...
<div class="row">
    <?php $__currentLoopData = $university_courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
        ...
        <div class="row mb-4">
            <div class="col-12">
                <label for="degreeFilter" class="my-3">Filter by Degree:</label>
                <select id="degreeFilter" class="form-control">
                    ...
                    <div class="single-course-wrap">
                        <div class="course-thumb">
                            <a href="<?php echo e(route('frontend.course.details', $course->id)); ?>">
                                <img decoding="async" class="img-fluid" src="<?php echo e(@$course->university->banner_image_show); ?>"
                                    alt="Music Theory Learn New student &amp; Fundamentals">
                            </a>
    
                            <div class="course-price-item">
                                <span class="course-price">
                                    <img decoding="async" class="img-fluid" src="<?php echo e($course->university->image_show); ?>"
                                        alt="">
                                </span>
                            </div>
                            <div class="meta-list">
                        ...
                        <div class="content-area">
                            ...
                            <div class="course-footer">
                                ...
                                <div class="cl-button">
                                    <a href="<?php echo e($apply_url); ?>" class="btn-details btn-link btn-tertiary-bg">Apply Now
...
<script>
    $(document).ready(function() {
        ...
        $('#degreeFilter').change(function() {
            ...
            console.log('Selected Degree:', degree); // Debugging

            const universityId =
            "<?php echo e(@$university->id); ?>"; // Get the university ID from the Blade template
            console.log('University ID:', universityId); // Debugging

            // Send an AJAX request to fetch filtered courses
            $.ajax({
                url: "<?php echo e(route('filter_courses')); ?>", // Route for filtering courses
                type: "GET",
                data: {
                    degree: degree,
                ...
                success: function(response) {
                    ...
                    // Clear the existing course cards
                    ...
                    `;
                    $('.programContainer').append(notFoundMessage);
                } else{

                    // Loop through the filtered courses and append them to the DOM
                            ...
                            <div class="single-course-wrap">
                                <div class="course-thumb">
                                    <a href="/course/details/${course.id}">
                                        <img decoding="async" class="img-fluid" src="${hostUrl}/upload/university/${course.university.banner_image}"
                                            alt="Course Image">
                                    </a>
    
                                    <div class="course-price-item">
                                        <span class="course-price">
                                            <img decoding="async" class="img-fluid" src="${hostUrl}/upload/university/${course.university.image}"
                                                alt="">
                                        </span>
                                    </div>
                                    <div class="meta-list">
                                ...
                                <div class="content-area">
                                                ...
                                                <tr>
                                                    <td width="80" class="ps-0">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="course-card__hints--text fs-12 fw-bold"
                                                                style="color: var(--product_text_color)">
                                                                ${course.university?.name?.substring(0, 50)}...
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                    ...
                                    <div class="course-footer">
                                        ...
                                        <div class="cl-button">
                                            <a href="/apply-cart/${course.id}" class="btn-details btn-link btn-tertiary-bg">Apply Now
                                                <i class="fas fa-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                ...
                `;
                        ...
                        // Append the course card to the row
                        $('.programContainer').append(courseCard);
                    });
                }
...
<?php /**PATH C:\laragon\www\rminternational-20241015\resources\views/Frontend/university/university_courses.blade.php ENDPATH**/ ?>