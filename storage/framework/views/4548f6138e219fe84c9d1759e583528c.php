                                ...
                                <div class="tab-pane fade show active" id="program-info-tab-content" role="tabpanel"
                                    ...
                                    <form novalidate="" method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="address"><?php echo e(__('Middle Name:')); ?></label>
                                                    <input value="<?php echo e($s_appliction->middle_name); ?>" type="text"
                                                        name="middle_name" id="address" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo e($s_appliction->birth_place); ?>" type="date"
                                            ...
                                            <div class="col-lg-12 mb-2">
                                                <div class="form-group">
                                                    <label for="address"><?php echo e(__('Hobby:')); ?></label>
                                                    <textarea type="text" name="hobby" id="address" class="form-control"><?php echo e($s_appliction->hobby); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="address"><?php echo e(__('Home Contact Name:')); ?></label>
                                                    <input value="<?php echo e($s_appliction->home_contact_name); ?>"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="address"><?php echo e(__('Home Contact Phone:')); ?></label>
                                                    <input value="<?php echo e($s_appliction->home_contact_phone); ?>"
...
<?php /**PATH /home/rmintern/public_html/resources/views/Backend/student_appliction/edit_personal_info.blade.php ENDPATH**/ ?>