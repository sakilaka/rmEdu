...
<head>
    ...
    <title><?php echo e(env('APP_NAME')); ?> | All Subscriber</title>
</head>
                                    ...
                                    <?php $__currentLoopData = $subscribers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subscriber): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <?php elseif($subscriber->status == 1): ?>
                                                    <span class="badge badge-success">Subscribed</span>
                                                <?php endif; ?>
                                            </td>
                                            <td class="text-right">
                                                
                                                <input type="hidden" value="<?php echo e($subscriber->id); ?>">
                        ...
                        <div class="modal-content">
                            <div class="modal-body text-center">
                                ...
                                <div class="m-t-20 flex">
                                    <form action="<?php echo e(route('admin.subscriber.delete')); ?>" method="POST"
                                        id="deleteForm">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="subscriber_id" id="modal_item_id" value="">
                                    </form>
                                    <div class="mt-3">
...
<?php /**PATH /home/rmintern/public_html/resources/views/Backend/subscriber/index.blade.php ENDPATH**/ ?>