<?php $__env->startSection('title', '- Instructor Register'); ?>
                    ...
                    <div class="border-md mx-0 rounded-3 row">
                        <div class="border-end-md col-md-6 p-sm-5 px-5">
                            ...
                            <center class="text-center">
                                <a href="<?php echo e(route('frontend.register')); ?>"><strong> Become a Student</strong></a>
                            </center>
                        ...
                        <div class="col-md-6 px-4 pt-2 pb-4 px-sm-5 pb-sm-5 pt-md-5">
                            ...
                            <div class="mt-sm-4 text-center"> Already have an account?<strong>
                                    <a href="<?php echo e(route('frontend.consultant_signin')); ?>"class="text-decoration-underline">Sign
                                        in</a> </strong>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('Frontend.layouts.master-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rmintern/public_html/resources/views/Frontend/auth/register_consultant.blade.php ENDPATH**/ ?>