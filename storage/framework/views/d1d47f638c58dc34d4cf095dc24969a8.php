...
<head>
    ...
    <title><?php echo e(env('APP_NAME')); ?> | Add Founder or Co-Founder</title>
</head>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-12 m-auto grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <form class="forms-sample" action="<?php echo e(route('admin.founder.store')); ?>"
...
<?php /**PATH /home/rmintern/public_html/resources/views/Backend/all_users/founder/create.blade.php ENDPATH**/ ?>