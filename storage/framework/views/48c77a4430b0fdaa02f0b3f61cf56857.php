                    ...
                    <div class="text-center card university" style="border-radius:8px">
                        <div class="card-body university-course-container">
                            <div class="course-university-image-container">
                                <a href="<?php echo e($course_details_url); ?>">
                                    <img decoding="async" src="<?php echo e(@$course->university->image_show); ?>"
                                        alt="<?php echo e($course->university->name ?? ''); ?>"
                                        title="<?php echo e($course->university->name ?? ''); ?>" style="border-radius: 8px"
                                        class="university-image">
                                </a>
                            </div>
                            <div class="mt-4">
                                <div class="mt-3">
                                    <a href="<?php echo e($course_details_url); ?>" class="text-dark university_name">
                                        <h5 style="font-size: 1.25rem;" class="fw-bold">
                                            <?php echo e(strlen($course->name) > 40 ? substr($course->name, 0, 40) . '...' : $course->name); ?>
                                ...
                                <div style="position: absolute; bottom: 0.85rem; width: 90%;">
                                                ...
                                                <td width="80" class="ps-0 border-0">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="course-card__hints--text fs-12 fw-bold"
                                                            ...
                                                            <?php echo substr(@$course->university->name, 0, 30); ?>...</div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span class="fw-bold"
                                            ...
                                            <?php echo e($course->year_fee ? 'Yearly $' . $course->year_fee : ''); ?>

                                        </span>
                                        <a href="<?php echo e($apply_url); ?>" class="btn btn-secondary-bg">
...
<?php /**PATH C:\laragon\www\rminternational-20241015\resources\views/Frontend/course/related_course.blade.php ENDPATH**/ ?>