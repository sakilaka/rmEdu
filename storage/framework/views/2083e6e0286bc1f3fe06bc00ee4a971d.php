...
<head>
    ...
    <title><?php echo e(env('APP_NAME')); ?> | Manage Landing Pages</title>
</head>
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="<?php echo e(route('admin.landing_page.create')); ?>" class="btn btn-primary btn-fw">
                                    ...
                                    <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr role="row" class="odd">
                                            ...
                                            <td
                                                ...
                                                <?php echo e($page->title); ?></td>
                                            <td
                                                style="font-size: 0.9rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 150px;">
                                                <a href="<?php echo e(route('landing_page.show_page', ['slug' => $page->slug])); ?>"
                                                    target="_blank">
                                                    <?php echo e(route('landing_page.show_page', ['slug' => $page->slug])); ?>

                                                </a>
                                            </td>
                                            <td class="text-center">
                                                <?php if($page->status == 1): ?>
                                                    <a href="<?php echo e(route('admin.landing_page.change_status', $page->id)); ?>">
                                            ...
                                            <td class="text-right">
                                                <a href="<?php echo e(route('admin.landing_page.edit', $page->id)); ?>"
                        ...
                        <div class="modal-content">
                            <div class="modal-body text-center">
                                ...
                                <div class="m-t-20 flex">
                                    <form action="<?php echo e(route('admin.landing_page.delete')); ?>" method="POST" id="deleteForm">
                                        <?php echo csrf_field(); ?>
...
<?php /**PATH /home/rmintern/public_html/resources/views/Backend/landing_pages/index.blade.php ENDPATH**/ ?>