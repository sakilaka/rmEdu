...
<head>
    ...
    <title><?php echo e(env('APP_NAME')); ?> | All Banner</title>
</head>
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="<?php echo e(route('home-banner.create')); ?>" class="btn btn-primary btn-fw">
                                    ...
                                    <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="d-flex justify-content-around align-items-center">
                                                <img src="<?php echo e($item->image_show); ?>" alt="" width="30px"
                                                    height="30px">
                                                <a class="btn btn-sm btn-danger p-2 my-1"
                                                    href="<?php echo e(route('home-banner-image.edit', $item->id)); ?>">Remove
                                                    Image</a>
                                            </td>
                                            <td class="text-center">
                                                <?php if($item->status == 1): ?>
                                                    <a href="<?php echo e(route('home-banner.status_toggle', $item->id)); ?>">
                                            ...
                                            <td class="text-right">
                                                <a href="<?php echo e(route('home-banner.edit', $item->id)); ?>"
                        ...
                        <div class="modal-content">
                            <div class="modal-body text-center">
                                ...
                                <div class="m-t-20 flex">
                                    <form action="<?php echo e(route('home-banner.delete')); ?>" method="POST" id="deleteForm">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="banner_id" id="modal_item_id" value="">
                                    </form>
                                    <div class="mt-3">
...
<?php /**PATH /home/rmintern/public_html/resources/views/Backend/home/banner/index.blade.php ENDPATH**/ ?>