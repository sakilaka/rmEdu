...
<head>
    ...
    <title><?php echo e(env('APP_NAME')); ?> | All Sub Category</title>
</head>
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="<?php echo e(route('home-sub-category.create')); ?>" class="btn btn-primary btn-fw">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $sub_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <img src="<?php echo e($item->image_show); ?>" alt="" width="60px"
                                                    height="40px">
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <?php if($item->status == 1): ?>
                                                    <a href="<?php echo e(route('home-sub-category.status_toggle',$item->id)); ?>">
                                            ...
                                            <td class="text-right">
                                                <a href="<?php echo e(route('home-sub-category.edit', $item->id)); ?>"
                        ...
                        <div class="modal-content">
                            <div class="modal-body text-center">
                                ...
                                <div class="m-t-20 flex">
                                    <form action="<?php echo e(route('home-sub-category.delete')); ?>" method="POST" id="deleteForm">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="subcategory_id" id="modal_item_id" value="">
                                    </form>
                                    <div class="mt-3">
...
<?php /**PATH /home/rmintern/public_html/resources/views/Backend/home/sub_category/index.blade.php ENDPATH**/ ?>