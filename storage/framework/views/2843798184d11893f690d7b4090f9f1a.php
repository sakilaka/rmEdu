        ...
        <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
            ...
            <div class="has-fee">
                ...
                <p style="font-size: 1.15rem;">
                    ...
                    $ <?php echo e($application->application_fee); ?>

                </p>
                <div class="service-notes">
                    <input <?php if($application->payment_method == 'bkash'): ?> checked <?php endif; ?> type="radio" id="option1"
                        name="payment_method" value="bkash">
                    <label for="option1">Pay With bKash</label><br>
                    <input <?php if($application->payment_method == 'cash'): ?> checked <?php endif; ?> type="radio" id="option2"
...
<?php /**PATH C:\laragon\www\rminternational-20241015\resources\views/Frontend/university/apply-parts/payment-panel.blade.php ENDPATH**/ ?>