        ...
        <div class="row">
            <div class="col-12 course-nav-tab">
                ...
                <div class="d-md-flex justify-content-md-between align-items-md-center text-center">
                    <div>
                        <h2 style="font-size: 2.5em; font-weight:700; font-family:'DM Sans', sans-serif">
                            <?php echo e($home_content->course_title); ?>
                ...
                <div class="tab-content mt-4">
                    <div role="tabpanel" class="tab-pane fade show active" id="all_program">
                        <div class="row justify-content-center gx-3 gy-4 mt-2">
                            <?php if(count($courses_all) > 0): ?>
                            <?php $__currentLoopData = $courses_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="single-course-wrap">
                                        <div class="course-thumb">
                                            ...
                                            <div class="course-price-item">
                                                <span class="course-price">
                                                    <img decoding="async" class="img-fluid"
                                                        src="<?php echo e($course->university->image_show ?? 'https://placehold.co/20x30'); ?>"
                                                        alt="<?php echo e($course->university->name ?? 'University Image'); ?>">
                                                </span>

                                            </div>
                                            <div class="meta-list">
                                                <a href="#"><?php echo e($course->department->name); ?></a>
                                                <a href="#"><?php echo e($course->degree->name); ?></a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="content-area">
                                            <div class="content-top">
                                                <ul class="list-unstyled">
                                                    ...
                                                    <li> <i class="fa fa-clock"></i>
                                                        <?php echo e($course->course_duration); ?> Year(s)</li>
                                                </ul>
                                            </div>
                                                            ...
                                                            <td width="80" class="ps-0">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="course-card__hints--text fs-12 fw-bold"
                                                                        ...
                                                                        <?php echo e(substr(@$course->university->name, 0, 150)); ?>...
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td width="80" class="ps-0">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="course-card__hints--text fs-12 fw-bold"
                                                                        style="color: var(--product_text_color)">
                                                                        Department:
                                                                        <?php echo e(@$course->department->name); ?></div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="ps-0">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="course-card__hints--text fs-12 fw-bold"
                                                                        style="color: var(--product_text_color)">
                                                                        Degree: <?php echo e(@$course->degree->name); ?>
                                            ...
                                            <div class="course-footer">
                                                <div class="lessons">
                                                    <?php if($course->year_fee): ?>
                                                    Yearly: $<?php echo e($course->year_fee); ?>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="our_top_pics">
                        <div class="row justify-content-center gx-3 gy-4 mt-2">
                            <?php if(count($courses_our_top_pics) > 0): ?>
                            <?php $__currentLoopData = $courses_our_top_pics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-12 col-md-6 col-lg-3 col-auto mt-sm-3 mt-md-4">
                                                        ...
                                                        <tr>
                                                            <td width="80" class="ps-0">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="course-card__hints--text fs-12 fw-bold"
                                                                        style="color: var(--product_text_color)">
                                                                        <?php echo e(substr(@$course->university->name, 0, 50)); ?>...
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="most_popular">
                        <div class="row justify-content-center gx-3 gy-4 mt-2">
                            <?php if(count($courses_most_popular) > 0): ?>
                            <?php $__currentLoopData = $courses_most_popular; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-12 col-md-6 col-lg-3 col-auto mt-sm-3 mt-md-4">
                                    ...
                                    <div class="single-course-wrap">
                                        <div class="course-thumb">
                                            ...
                                            <div class="course-price-item">
                                                <span class="course-price">
                                                    <img decoding="async" class="img-fluid"
                                                        src="<?php echo e($course->university->image_show); ?>" alt="">
                                                </span>
                                            </div>
                                            <div class="meta-list">
                                                <a href="#"><?php echo e($course->department->name); ?></a>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="fastest_admissions">
                        <div class="row justify-content-center gx-3 gy-4 mt-2">
                            <?php if(count($courses_fastest_admissions) > 0): ?>
                            <?php $__currentLoopData = $courses_fastest_admissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-12 col-md-6 col-lg-3 col-auto mt-sm-3 mt-md-4">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="highest_rating">
                        <div class="row justify-content-center gx-3 gy-4 mt-2">
                            <?php if(count($courses_highest_rating) > 0): ?>
                            <?php $__currentLoopData = $courses_highest_rating; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-12 col-md-6 col-lg-3 col-auto mt-sm-3 mt-md-4">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="top_ranked">
                        <div class="row justify-content-center gx-3 gy-4 mt-2">
                            <?php if(count($courses_top_ranked) > 0): ?>
                            <?php $__currentLoopData = $courses_top_ranked; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-12 col-md-6 col-lg-3 col-auto mt-sm-3 mt-md-4">
                ...
                <div class="text-center mt-3 firstbutton">
                    <a href="<?php echo e(route('frontend.university_course_list')); ?>"
...
</div><?php /**PATH C:\laragon\www\rminternational-20241015\resources\views/Frontend/layouts/parts/courses-filter.blade.php ENDPATH**/ ?>