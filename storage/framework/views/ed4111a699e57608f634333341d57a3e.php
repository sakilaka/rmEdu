...
<head>
    ...
    <title><?php echo e(env('APP_NAME')); ?> | All Admin</title>
</head>
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="<?php echo e(route('backend.create_admin')); ?>" class="btn btn-primary btn-fw">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <img src="<?php echo e($admin->image_show); ?>" alt="<?php echo e($admin->name); ?>" width="40px"
                                                    height="40px">&nbsp;&nbsp;
                                            ...
                                            <td class="text-right">
                                                <a href="<?php echo e(route('backend.edit_admin', $admin->id)); ?>"
                                                    class="btn text-primary">
                                                    <i class="fa fa-edit" aria-hidden="true"></i>
                                                </a>
                                                <input type="hidden" value="<?php echo e($admin->id); ?>">
                        ...
                        <div class="modal-content">
                            <div class="modal-body text-center">
                                ...
                                <div class="m-t-20 flex">
                                    <form action="<?php echo e(route('backend.delete_admin')); ?>" method="POST" id="deleteForm">
                                        <?php echo csrf_field(); ?>
...
<?php /**PATH /home/rmintern/public_html/resources/views/Backend/all_users/admin/index.blade.php ENDPATH**/ ?>