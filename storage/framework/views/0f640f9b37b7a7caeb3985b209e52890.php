...
<head>
    ...
    <title><?php echo e(env('APP_NAME')); ?> | Application Details of <?php echo e($s_appliction->application_code); ?></title>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title">
                            Application Details of <?php echo e($s_appliction->application_code); ?>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-12 mt-3">
                                    ...
                                    <p>profile Picture</p>
                                    <img src="<?php echo e(asset('upload/photos/' .$s_appliction->profile_photo )); ?>" width='160px' height='160px'>
                                            ...
                                            <?php $__currentLoopData = $s_appliction->educations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <p><?php echo e($item->country); ?></p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p><?php echo e($item->field); ?> </p>
                                                    </td>
                                                    <td class="text-center">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <button style="margin-left: 18px" type="button"
                                                        ...
                                                        Details</button>
                                                    <a href="<?php echo e(route('frontend.application-file-download', $document->id)); ?>"
...
<?php /**PATH C:\laragon\www\rminternational-20241015\resources\views/User-Backend/application_view.blade.php ENDPATH**/ ?>