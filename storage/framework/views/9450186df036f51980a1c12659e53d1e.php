...
<head>
    ...
    <title><?php echo e(env('APP_NAME')); ?> | Home Content Setup</title>
</head>
...
<body>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title">
                            <?php echo e(__('Home Content Setup')); ?>
                        ...
                        <div class="card card-body col-md-12">
                            <div class="rounded">
                                ...
                                <div class="collapse" id="collapseContent">
                                    <form action="<?php echo e(route('backend.home_banner_section.update')); ?>" method="post"
                                            ...
                                            <div class="row col-sm-12 col-md-6">
                                                ...
                                                <div
                                                    ...
                                                    <div class="px-3 border border-secondary rounded">
                                                        <img src="<?php echo e($home_content->banner_image_show ?? asset('frontend/images/No-image.jpg')); ?>"
                                                            alt="" class="img-fluid"
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <input type="file" class="form-control" name="banner_video"
                                                            value="<?php echo e($home_content->banner_video); ?>" />
                                                        <div class="ml-2">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <video controls height="350px" width="460px">
                                                                <source src="<?php echo e($home_content->banner_video_show); ?>"
                                        ...
                                        <div class="row mt-4 mb-4">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="mg-t-10 mg-sm-t-0">
                                                    <textarea name="banner_text" class="form-control summernote"><?php echo e($home_content->banner_text ?? ''); ?></textarea>
                                                </div>
                                            </div>
                                            <hr>
                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-5 mt-3">
                                                            <label class=" form-control-label">Button Text:<span
                                                                    class="tx-danger"></span></label>
                                                            <div class="mg-t-10 mg-sm-t-0">
                                                                <input type="text" value="<?php echo e($faq->question); ?>"
                                                        ...
                                                        <div class="col-sm-7 mt-3 d-flex align-items-center ">
                                                            <div style="width: 97%;">
                                                                <label class=" form-control-label">Button URL:<span
                                                                        class="tx-danger"></span></label>
                                                                <div class="mg-t-10 mg-sm-t-0">
                                                                    <input value="<?php echo e($faq->answer); ?>" type="text"
                            ...
                            <div class="mt-3 rounded">
                                ...
                                <div class="collapse" id="collapseContent_hero_slider">
                                    <form action="<?php echo e(route('backend.home_hero_slider_section.update')); ?>"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="text"
                                                            value="<?php echo e($home_content->hero_slider_title_1 ?? ''); ?>"
                                                ...
                                                <div
                                                    class="col-sm-12 col-md-5 d-flex justify-content-center align-items-center">
                                                    <div class="px-3 mt-3">
                                                        <img src="<?php echo e($home_content->hero_slider_bg_1 ? asset('upload/home_content/hero_slider/' . $home_content->hero_slider_bg_1) : asset('frontend/images/No-image.jpg')); ?>"
                                                            alt="" class="img-fluid"
                                                            style="border-radius: 10px; max-height: 200px !important;"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 ">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="text"
                                                            value="<?php echo e($home_content->hero_slider_title_2 ?? ''); ?>"
                                                ...
                                                <div class="row col-sm-12 mt-3">
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        ...
                                                        ?>
                                                        <input type="text"
                                                            value="<?php echo e($heroSliderBtnText2->hero_slider_btn_text_2_first ?? ''); ?>"
                                                            name="hero_slider_btn_text_2_first" class="form-control"
                                                            placeholder="Enter First Button Text">
                                                    </div>
                                                    <div class="col-12 col-md-6">
                                                        <input type="text"
                                                            value="<?php echo e($heroSliderBtnText2->hero_slider_btn_url_2_first ?? ''); ?>"
                                                            name="hero_slider_btn_url_2_first" class="form-control"
                                                            placeholder="Enter First Button URL">
                                                    </div>
                                                    <div class="col-12 col-md-6 mt-2">
                                                        <input type="text"
                                                            value="<?php echo e($heroSliderBtnText2->hero_slider_btn_text_2_second ?? ''); ?>"
                                                            name="hero_slider_btn_text_2_second" class="form-control"
                                                            placeholder="Enter Second Button Text">
                                                    </div>
                                                    <div class="col-12 col-md-6 mt-2">
                                                        <input type="text"
                                                            value="<?php echo e($heroSliderBtnText2->hero_slider_btn_url_2_second ?? ''); ?>"
                                                ...
                                                <div
                                                    class="col-sm-12 col-md-5 d-flex justify-content-center align-items-center">
                                                    <div class="px-3 mt-3">
                                                        <img src="<?php echo e($home_content->hero_slider_bg_2 ? asset('upload/home_content/hero_slider/' . $home_content->hero_slider_bg_2) : asset('frontend/images/No-image.jpg')); ?>"
                                                            alt="" class="img-fluid"
                                                            style="border-radius: 10px; max-height: 200px !important;"
                            ...
                            <div class="mt-3 rounded">
                                ...
                                <div class="collapse" id="university_location_section">
                                    <form action="<?php echo e(route('backend.home_location_section.update')); ?>" method="post"
                                        enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        <div class="card-body">
                                            <div class="row mt-4">
                                                <div class="col-sm-12 ">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="text"
                                                            value="<?php echo e($home_content->university_location_title ?? ''); ?>"
                                            ...
                                            <div class="col-sm-12 mt-3">
                                                <div class="mg-t-10 mg-sm-t-0 add-data-content">
                                                    <?php if($home_content_locations->count() == 0): ?>
                                                    ...
                                                    <?php else: ?>
                                                        <?php $__currentLoopData = $home_content_locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $home_content_location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div class="d-flex align-items-center mt-2 row">
                                                                <div class="col-11 row">
                                                                    <div class="col-sm-12 col-md-6 mt-3">
                                                                        <label class="form-control-label">
                                                                        ...
                                                                        <div class="dropify-wrapper"
                                                                            ...
                                                                            <input type="file" class="dropify"
                                                                                name="old_location_image[<?php echo e($home_content_location->id); ?>]"
                                                                                accept="image/*"
                                                                                id="location_image_upload_<?php echo e($k); ?>">
                                                                            <button type="button"
                                                                                class="dropify-clear">Remove</button>
                                                                            <div class="dropify-preview">
                                                                                <span class="dropify-render"></span>
                                                                    ...
                                                                    <div
                                                                        class="col-sm-12 col-md-5 d-flex justify-content-center align-items-center">
                                                                        <div class="px-3 mt-3">
                                                                            <img src="<?php echo e($home_content_location->photo ? asset('upload/home_content/university_location/' . $home_content_location->photo) : asset('frontend/images/No-image.jpg')); ?>"
                                                                                alt="" class="img-fluid"
                                                                                style="border-radius: 10px; max-height: 190px !important;"
                                                                                id="location_image_preview_<?php echo e($k); ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        <select
                                                                            ...
                                                                            name="old_type_loction_id[<?php echo e($home_content_location->id); ?>]"
                                                                            required>
                                                                            <option value="">Select type</option>
                                                                            <option
                                                                                <?php if($home_content_location->type_loction_id == '1'): ?> selected <?php endif; ?>
                                                                                value="1">Continent</option>
                                                                            <option
                                                                                <?php if($home_content_location->type_loction_id == '2'): ?> selected <?php endif; ?>
                                                                                value="2">Country</option>
                                                                            <option
                                                                                <?php if($home_content_location->type_loction_id == '3'): ?> selected <?php endif; ?>
                                                                                value="3">State</option>
                                                                            <option
                                                                                <?php if($home_content_location->type_loction_id == '4'): ?> selected <?php endif; ?>
                                                                                value="4">City</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-5">
                                                                    ...
                                                                    <div class="d-flex  align-items-center">
                                                                        <select class="form-control form-control-lg"
                                                                            id="location"
                                                                            name="old_location_id[<?php echo e($home_content_location->id); ?>]"
                                                                            required>
                                                                            <option value="">Select Location
                                                                            </option>
                                                                            <?php if($home_content_location->type_loction_id == '1'): ?>
                                                                                <?php $__currentLoopData = $continents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $continent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                    <option
                                                                                        <?php if($continent->id == $home_content_location->location_id): ?> selected <?php endif; ?>
                                                                                        value="<?php echo e($continent->id); ?>">
                                                                                        <?php echo e($continent->name); ?></option>
                                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                            <?php elseif($home_content_location->type_loction_id == '2'): ?>
                                                                                <?php $__currentLoopData = $countrys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                    <option
                                                                                        <?php if($country->id == $home_content_location->location_id): ?> selected <?php endif; ?>
                                                                                        value="<?php echo e($country->id); ?>">
                                                                                        <?php echo e($country->name); ?></option>
                                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                            <?php elseif($home_content_location->type_loction_id == '3'): ?>
                                                                                <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                    <option
                                                                                        <?php if($state->id == $home_content_location->location_id): ?> selected <?php endif; ?>
                                                                                        value="<?php echo e($state->id); ?>">
                                                                                        <?php echo e($state->name); ?></option>
                                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                            <?php elseif($home_content_location->type_loction_id == '4'): ?>
                                                                                <?php $__currentLoopData = $citys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                    <option
                                                                                        <?php if($city->id == $home_content_location->location_id): ?> selected <?php endif; ?>
                                                                ...
                                                                <?php if($k == $home_content_locations->count() - 1): ?>
                                                                    <a id="plus-btn-data-content"
                                                                        href="javascript:void(0)"
                                                                        class="plus-btn-data-content px-1 p-0 m-0 ml-2"><i
                                                                            class="fas fa-plus"></i></a>
                                                                <?php else: ?>
                                                                    <a home_content_location_id="<?php echo e($home_content_location->id); ?>"
                                                                        href="javascript:void(0)"
                            ...
                            <div class="mt-3 rounded">
                                ...
                                <div class="collapse" id="collapseContent_university">
                                    <form action="<?php echo e(route('backend.home_university_section.update')); ?>"
                                        method="post" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        <div class="card-body">
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-sm-12 ">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="text"
                                                            value="<?php echo e($home_content->university_title ?? ''); ?>"
                                                ...
                                                <div
                                                    class="col-sm-12 col-md-5 d-flex justify-content-center align-items-center">
                                                    <div class="px-3 mt-3">
                                                        <img src="<?php echo e($home_content->university_image_show ?? asset('frontend/images/No-image.jpg')); ?>"
                                                            alt="" class="img-fluid"
                                                            style="border-radius: 10px; max-height: 200px !important;"
                            ...
                            <div class="mt-3 rounded">
                                ...
                                <div class="collapse" id="collapseContent_3">
                                    <div class="card-body">
                                        <form action="<?php echo e(route('backend.home_course_section.update')); ?>"
                                            method="post" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <div class="row mt-4">
                                                <div class="col-sm-12 ">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="text"
                                                            value="<?php echo e($home_content->course_title); ?>"
                            ...
                            <div class="mt-3 rounded">
                                ...
                                <div class="collapse" id="collapseContent_4">
                                    <div class="card-body">
                                        <form action="<?php echo e(route('backend.home_partner_section.update')); ?>"
                                            method="post" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <div class="row mt-4">
                                                <div class="col-sm-12 ">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="text"
                                                            value="<?php echo e($home_content->partner_title); ?>"
                            ...
                            <div class="mt-3 rounded">
                                ...
                                <div class="collapse" id="collapseContent_5">
                                    <form action="<?php echo e(route('backend.home_learn_section.update')); ?>" method="post"
                                        enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        <div class="card-body">
                                            <div class="row mt-4">
                                                ...
                                                <div
                                                    class="col-sm-12 col-md-5 d-flex justify-content-center align-items-center">
                                                    <div class="px-3 mt-3">
                                                        <img src="<?php echo e($home_content->learn_image_show ?? asset('frontend/images/No-image.jpg')); ?>"
                                                            alt="" class="img-fluid"
                                                            style="border-radius: 10px; max-height: 200px !important;"
                                                ...
                                                <div class="col-sm-12 mt-4">
                                                    <label class=" form-control-label">Title:<span
                                                            class="tx-danger"></span></label>
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <textarea type="text" name="learn_title" class="form-control summernote"><?php echo e($home_content->learn_title); ?></textarea>
                                                    </div>
                                                </div>
                                            </div>

                                            <?php if($learn_texts->count() == 0): ?>
                                                <div class="mt-4">
                                            ...
                                            <?php else: ?>
                                                <div class="add-question-data-show">
                                                    ...
                                                    <div class="mt-4">
                                                        <div class="col-sm-12 show-add-tagline-data">
                                                            <?php $__currentLoopData = $learn_texts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $learn_text): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <div class="d-flex mt-3">
                                                                    <div class=""
                                                                        ...
                                                                        <div class="row mt-3">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                <input
                                                                                    value="<?php echo e($learn_text->title); ?>"
                                                                                    type="text"
                                                                                    name="title_old[<?php echo e($learn_text->id); ?>]"
                                                                                    class="form-control"
                                                                                    placeholder="Enter Title">
                                                                            </div>
                                                                            <label class="col-sm-2 mt-3">URL</label>
                                                                            <div class="col-sm-10 mt-2">
                                                                                <input value="<?php echo e($learn_text->url); ?>"
                                                                                    type="text"
                                                                                    name="url_old[<?php echo e($learn_text->id); ?>]"
                                                                                    class="form-control"
                                                                                    placeholder="Enter URL">
                                                                            </div>
                                                                            <label
                                                                            ...
                                                                            <div class="col-sm-10 mt-2">
                                                                                <textarea type="text" name="description_old[<?php echo e($learn_text->id); ?>]" class="form-control"
                                                                                    placeholder="Enter Short Description"><?php echo e($learn_text->description); ?></textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <label class=" form-control-label"></label>
                                                                    <?php if($k == 0): ?>
                                                                        <a id="plus-btn-data-tagline"
                                                                            ...
                                                                            class="plus-btn-data px-1 p-0 m-0 ml-2"><i
                                                                                class="fas fa-plus"></i></a>
                                                                    <?php else: ?>
                                                                        <a learn_id="<?php echo e($learn_text->id); ?>"
                                                                            href="javascript:void(0)"
                            ...
                            <div class="mt-3 rounded">
                                ...
                                <div class="collapse" id="collapseContent_6">
                                    <div class="card-body">
                                        <form action="<?php echo e(route('backend.home_media_partner_section.update')); ?>"
                                            method="post" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <div class="row mt-4">
                                                <div class="col-sm-12 ">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="text"
                                                            value="<?php echo e($home_content->client_title); ?>"
                            ...
                            <div class="mt-3 rounded">
                                ...
                                <div class="collapse" id="collapseContent_7">
                                    <div class="card-body">
                                        <form action="<?php echo e(route('backend.home_counting_section.update')); ?>"
                                            method="post" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <div class="row mt-4">
                                                <div class="col-sm-12 ">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="text"
                                                            value="<?php echo e($home_content->counting_title); ?>"
                                                ...
                                                <div class="col-sm-6 mt-3">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="text"
                                                            value="<?php echo e($home_content->count_text_1); ?>"
                                                ...
                                                <div class="col-sm-6 mt-3">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="text"
                                                            value="<?php echo e($home_content->count_num_1); ?>"
                                                ...
                                                <div class="col-sm-6 mt-3">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="text"
                                                            value="<?php echo e($home_content->count_text_2); ?>"
                                                ...
                                                <div class="col-sm-6 mt-3">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="text"
                                                            value="<?php echo e($home_content->count_num_2); ?>"
                                                ...
                                                <div class="col-sm-6 mt-3">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="text"
                                                            value="<?php echo e($home_content->count_text_3); ?>"
                                                ...
                                                <div class="col-sm-6 mt-3">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="text"
                                                            value="<?php echo e($home_content->count_num_3); ?>"
                                                ...
                                                <div class="col-sm-6 mt-3">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="text"
                                                            value="<?php echo e($home_content->count_text_4); ?>"
                                                ...
                                                <div class="col-sm-6 mt-3">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="text"
                                                            value="<?php echo e($home_content->count_num_4); ?>"
                            ...
                            <div class="mt-3 rounded">
                                ...
                                <div class="collapse" id="collapseContent_8">
                                    <form action="<?php echo e(route('backend.home_testimonials_section.update')); ?>"
                                        method="post" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        <div class="card-body">
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-sm-6 ">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="text"
                                                            value="<?php echo e($home_content->review_title1); ?>"
                                                ...
                                                <div class="col-sm-6 ">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="text"
                                                            value="<?php echo e($home_content->review_title2); ?>"
                            ...
                            <div class="mt-3 rounded">
                                ...
                                <div class="collapse" id="collapseContent_10">
                                    <form action="<?php echo e(route('backend.home_question_section.update')); ?>" method="post"
                                        enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        <div class="card-body">
                                            <div class="row mt-4">
                                                ...
                                                <div
                                                    class="col-sm-12 col-md-5 d-flex justify-content-center align-items-center">
                                                    <div class="px-3 mt-3">
                                                        <img src="<?php echo e($home_content->question_image_show ?? asset('frontend/images/No-image.jpg')); ?>"
                                                            alt="" class="img-fluid"
                                                            style="border-radius: 10px; max-height: 200px !important;"
                                                ...
                                                <div class="col-sm-12 mt-4">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="text"
                                                            value="<?php echo e($home_content->question_title); ?>"
                                                ...
                                                <div class="col-sm-12 mt-4">
                                                    <label class=" form-control-label">Short Description:<span
                                                            class="tx-danger"></span></label>
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <textarea type="text" name="ques_short_des" class="form-control" placeholder="Enter Title 1"><?php echo e($home_content->ques_short_des); ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6 mt-4">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="text"
                                                            value="<?php echo e($home_content->question_button_text); ?>"
                                                ...
                                                <div class="col-sm-6 mt-4">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="text"
                                                            value="<?php echo e($home_content->question_button_url); ?>"
                            ...
                            <div class="mt-3 rounded">
                                ...
                                <div class="collapse" id="collapseContent_11">
                                    <div class="card-body">
                                        <form action="<?php echo e(route('backend.home_register_section.update')); ?>"
                                            method="post" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <div class="row mt-4">
                                                <div class="col-sm-12 col-md-6 mt-3">
                                                ...
                                                <div
                                                    class="col-sm-12 col-md-5 d-flex justify-content-center align-items-center">
                                                    <div class="px-3 mt-3">
                                                        <img src="<?php echo e($home_content->register_image_show ?? asset('frontend/images/No-image.jpg')); ?>"
                                                            alt="" class="img-fluid"
                                                            style="border-radius: 10px; max-height: 200px !important;"
                                                ...
                                                <div class="col-sm-12 mt-4">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="text"
                                                            value="<?php echo e($home_content->register_title); ?>"
                                                ...
                                                <div class="col-sm-12 mt-4">
                                                    <label class=" form-control-label">Short Description:<span
                                                            class="tx-danger"></span></label>
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <textarea type="text" name="register_des" class="form-control" placeholder="Enter Short Description"><?php echo e($home_content->register_des); ?></textarea>
                                                    </div>
                                                </div>
                            ...
                            <div class="mt-3 rounded">
                                ...
                                <div class="collapse" id="footer_image_gallery">
                                    <form action="<?php echo e(route('backend.home_footer_activity_gallery.update')); ?>"
                                        method="post" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        <div class="card-body">
                                            <div class="col-sm-12 mt-3">
                                                <div class="mg-t-10 mg-sm-t-0 add-data-content-footer_image">
                                                    ...
                                                    <?php else: ?>
                                                        <?php $__currentLoopData = $footer_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div class="d-flex align-items-center mt-2 row">
                                                                <input type="hidden"
                                                                    name="old_footer_image_<?php echo e($k); ?>"
                                                                ...
                                                                <div class="col-sm-12 col-md-6 mt-3">
                                                                    ...
                                                                    <div class="dropify-wrapper"
                                                                        ...
                                                                        <input type="file" class="dropify"
                                                                            name="footer_image[]" accept="image/*"
                                                                            id="footer_image_upload_<?php echo e($k); ?>">
                                                                        <button type="button"
                                                                            class="dropify-clear">Remove</button>
                                                                        <div class="dropify-preview">
                                                                            <span class="dropify-render"></span>
                                                                ...
                                                                <div
                                                                    class="col-sm-12 col-md-5 d-flex justify-content-center align-items-center">
                                                                    <div class="px-3 mt-3">
                                                                        <img src="<?php echo e(asset('upload/footer_image/' . $image)); ?>"
                                                                            alt="" class="img-fluid"
                                                                            style="border-radius: 10px; max-height: 200px !important;"
                                                                            id="footer_image_preview_<?php echo e($k); ?>">
                                                                    </div>
                                                                </div>

                                                                <?php if($k == count($footer_images) - 1): ?>
                                                                    <a id="plus-btn-data-content-footer_image"
                                                                        href="javascript:void(0)"
                                                                        class="plus-btn-data-content-footer_image px-1 p-0 m-0 ml-2"><i
                                                                            class="fas fa-plus"></i></a>
                                                                <?php else: ?>
                                                                    <a home_content_footer_image_id="<?php echo e($k); ?>"
                                                                        href="javascript:void(0)"
    ...
    <?php $__currentLoopData = $footer_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <script>
            $('#footer_image_upload_' + <?php echo json_encode($k, 15, 512) ?>).on('change', function(e) {
                ...
                if (fileInput.files && fileInput.files[0]) {
                    ...
                    reader.onload = function(e) {
                        $('#footer_image_preview_' + <?php echo json_encode($k, 15, 512) ?>).attr('src', e.target.result);
                    };
    ...
    <?php $__currentLoopData = $home_content_locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <script>
            $('#location_image_upload_' + <?php echo json_encode($k, 15, 512) ?>).on('change', function(e) {
                var fileInput = $(this)[0];
                ...
                if (fileInput.files && fileInput.files[0]) {
                    ...
                    reader.onload = function(e) {
                        $('#location_image_preview_' + <?php echo json_encode($k, 15, 512) ?>).attr('src', e.target.result);
                    };
    ...
    <script>
        $(document).on('change', '.on_change_u_lo_type', function() {
            let id = $(this).val();
            let url = '<?php echo e(url('/get_location_u/')); ?>/' + id;
...
<?php /**PATH /home/rmintern/public_html/resources/views/Backend/home/content_setup/index.blade.php ENDPATH**/ ?>