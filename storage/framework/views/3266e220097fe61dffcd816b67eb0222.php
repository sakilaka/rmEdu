...
<head>
    ...
    <title><?php echo e(env('APP_NAME')); ?> | All Continent</title>
</head>
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="<?php echo e(route('continent.create')); ?>" class="btn btn-primary btn-fw">
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="text-center">
                                                <?php if($item->status == 1): ?>
                                                    <a href="<?php echo e(route('continent.toggle_status', $item->id)); ?>">
                                            ...
                                            <td class="text-right">
                                                <a href="<?php echo e(route('continent.edit', $item->id)); ?>"
                        ...
                        <div class="modal-content">
                            <div class="modal-body text-center">
                                ...
                                <div class="m-t-20 flex">
                                    <form action="<?php echo e(route('continent.delete')); ?>" method="POST" id="deleteForm">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="continent_id" id="modal_item_id" value="">
                                    </form>
                                    <div class="mt-3">
...
<?php /**PATH /home/rmintern/public_html/resources/views/Backend/medical_tourism/continent/index.blade.php ENDPATH**/ ?>