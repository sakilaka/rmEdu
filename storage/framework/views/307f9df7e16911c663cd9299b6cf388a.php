...
<head>
    ...
    <title><?php echo e(env('APP_NAME')); ?> | All Tesimonial</title>
</head>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <?php if($review->type == 'Program'): ?>
                                                    <?php echo e(@$review->course->university->name ?? ''); ?>

                                                <?php elseif($review->type == 'university'): ?>
                                                    <?php echo e(@$review->university->name ?? ''); ?>

                                                <?php endif; ?>
                                            </td>
                                            <td><?php echo e($review->user->name ?? ''); ?></td>
                                            <td><?php echo e($review->ratting); ?></td>
                                            <td class="text-right">
                                                <a href="<?php echo e(route('admin.review.edit', $review->id)); ?>"
                                                    class="btn text-primary">
                                                    <i class="fa fa-edit" aria-hidden="true"></i>
                                                </a>
                                                <input type="hidden" value="<?php echo e($review->id); ?>">
                        ...
                        <div class="modal-content">
                            <div class="modal-body text-center">
                                ...
                                <div class="m-t-20 flex">
                                    <form action="<?php echo e(route('admin.review.delete')); ?>" method="POST"
                                        id="deleteForm">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="review_id" id="modal_item_id" value="">
                                    </form>
                                    <div class="mt-3">
...
<?php /**PATH /home/rmintern/public_html/resources/views/Backend/review/index.blade.php ENDPATH**/ ?>