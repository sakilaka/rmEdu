...
<head>
    ...
    <title><?php echo e(env('APP_NAME')); ?> | In - Transaction</title>
</head>
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                <option value="Student Payment"
                                                    <?php echo e(old('category') == 'Student Payment' ? 'selected' : ''); ?>>Student
                                                    Payment</option>
                                                <option value="Work Visa"
                                                    <?php echo e(old('category') == 'Work Visa' ? 'selected' : ''); ?>>Work Visa
                                                </option>
                                                <option value="Student Visa"
                                                    <?php echo e(old('category') == 'Student Visa' ? 'selected' : ''); ?>>Student
                                                    Visa</option>
                                                <option value="Ticketing"
                                                    <?php echo e(old('category') == 'Ticketing' ? 'selected' : ''); ?>>Ticketing
                                                </option>
                                                <option value="Tourist"
                                                    <?php echo e(old('category') == 'Tourist' ? 'selected' : ''); ?>>Tourist
                                                </option>
                                                <option value="Ranzee In"
                                                    <?php echo e(old('category') == 'Ranzee In' ? 'selected' : ''); ?>>Ranzee In
                                                </option>
                                                <option value="Rakin In"
                                                    <?php echo e(old('category') == 'Rakin In' ? 'selected' : ''); ?>>Rakin In
                                                </option>
                                                ...
                                                <option value="Other"
                                                    <?php echo e(old('category') == 'Other' ? 'selected' : ''); ?>>Other</option>
                                            </select>
...
<?php /**PATH /home/rmintern/public_html/resources/views/Backend/transactions/in_form_add.blade.php ENDPATH**/ ?>