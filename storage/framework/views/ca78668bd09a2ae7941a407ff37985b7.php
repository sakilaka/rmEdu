...
<head>
    ...
    <title><?php echo e(env('APP_NAME')); ?> | All Country</title>
</head>
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="<?php echo e(route('country.create')); ?>" class="btn btn-primary btn-fw">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <img src="<?php echo e($item->image_show); ?>" alt="<?php echo e($item->name); ?>" width="30px"
                                                    height="30px">
                                            </td>
                                            <td><?php echo e($item->name); ?></td>
                                            <td><?php echo e($item->continent->name ?? ''); ?></td>
                                            <td class="text-center">
                                                <?php if($item->status == 1): ?>
                                                    <a href="<?php echo e(route('country.toggle_status', $item->id)); ?>">
                                            ...
                                            <td class="text-right">
                                                <a href="<?php echo e(route('country.edit', $item->id)); ?>"
                        ...
                        <div class="modal-content">
                            <div class="modal-body text-center">
                                ...
                                <div class="m-t-20 flex">
                                    <form action="<?php echo e(route('country.delete')); ?>" method="POST" id="deleteForm">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="country_id" id="modal_item_id" value="">
                                    </form>
                                    <div class="mt-3">
...
<?php /**PATH /home/rmintern/public_html/resources/views/Backend/medical_tourism/country/index.blade.php ENDPATH**/ ?>