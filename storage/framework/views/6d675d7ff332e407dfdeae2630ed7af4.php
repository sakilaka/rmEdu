...
<head>
    ...
    <title><?php echo e(env('APP_NAME')); ?> | Password Reset Request</title>
                ...
                <div class="row w-100">
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-center p-5">
                            ...
                            <form class="pt-3" method="POST" action="<?php echo e(route('forget.send_mail_f_password')); ?>">
                            ...
                            <div class="my-2 d-flex justify-content-center align-items-center">
                                <a href="<?php echo e(route('login')); ?>" class="text-primary mt-3">
                                    Back to Login
                                </a>
                            </div>
                        </div>
...
<?php /**PATH /home/rmintern/public_html/resources/views/auth/forgot_password.blade.php ENDPATH**/ ?>