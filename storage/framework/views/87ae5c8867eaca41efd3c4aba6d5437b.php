...
<head>
    ...
    <title><?php echo e(env('APP_NAME')); ?> | All Menu</title>
</head>
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="<?php echo e(route('admin.create_menu')); ?>" class="btn btn-primary btn-fw">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <?php if($item->type == 'header_menu'): ?>
                                                    Header Menu
                                                <?php elseif($item->type == 'footer_menu'): ?>
                                                    Footer Menu
                                                <?php endif; ?>
                                            </td>
                                            <td><?php echo e($item->name); ?></td>
                                            <td class="text-center"><?php echo e($item->position); ?></td>
                                            <td class="text-center"><?php echo e($item->column_num); ?></td>
                                            <td class="text-center">
                                                <?php if($item->status == 1): ?>
                                                    <a href="<?php echo e(route('admin.menu_status_toggle', $item->id)); ?>">
                                            ...
                                            <td class="text-right">
                                                <a href="<?php echo e(route('admin.edit_menu', $item->id)); ?>"
                        ...
                        <div class="modal-content">
                            <div class="modal-body text-center">
                                ...
                                <div class="m-t-20 flex">
                                    <form action="<?php echo e(route('admin.delete_menu')); ?>" method="POST" id="deleteForm">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="menu_id" id="modal_item_id" value="">
                                    </form>
                                    <div class="mt-3">
...
<?php /**PATH /home/rmintern/public_html/resources/views/Backend/home/menu/index.blade.php ENDPATH**/ ?>