...
<?php $__env->startSection('main_content'); ?>
    <div class="container d-lg-flex p-0" style="flex-flow: row-reverse; margin-top:9rem;">
                ...
                <div class="applicationList_wrapper mb-4">
                    ...
                    <div class="d-none d-lg-block app-summary">
                        ...
                        <div class="mt-2 mb2 d-flex flex-column">
                            ...
                            <button class="btn-add-prog btn mb-4" onclick="window.location.href='<?php echo e($route); ?>'">Add
                                another program
                            ...
                            <div class="row">
                                <div class="col-12  m-auto p-0">
                                    <div class="multisteps-form__form" style="height: 2126px;">
                                                        ...
                                                        <div class="col-12 col-sm-6">
                                                            <div class=" form-label-group mt-2">
                                                                ...
                                                                <input type="tel" id="phone" name="phone"
                                                                    ...
                                                                    class="form-control"
                                                                    value="<?php echo e(auth()->user()->phone ?? $application->phone); ?>">
                                                        ...
                                                        <div class="col-12 col-sm-6">
                                                            <div class="form-label-group mt-2">
                                                                <select class="custom-select d-block w-100"
                                                                    ...
                                                                    <option
                                                                        <?php if($application->in_alcoholic == 0): ?> selected <?php endif; ?>
                                                                        value="false">No</option>
                                                                    <option
                                                                        <?php if($application->in_alcoholic == 1): ?> selected <?php endif; ?>
                                                            ...
                                                            <div class="col-12 col-sm-6">
                                                                <div class=" form-label-group mt-2">
                                                                    ...
                                                                    <input type="text" id="home_country"
                                                                        ...
                                                                        maxlength=""
                                                                        value="<?php echo e($application->home_country); ?>">
                                                                    <label for="country"
                                                                        class="form-control-placeholder">
                                                                        Country</label>
                                                            ...
                                                            <div class="col-12 col-sm-6">
                                                                <div class=" form-label-group mt-2">
                                                                    ...
                                                                    <input type="text" id="post_country"
                                                                        ...
                                                                        placeholder="Country" class="form-control"
                                                                        maxlength=""
                                                                        value="<?php echo e($application->current_country); ?>">
                                                                    <label for="country"
                                                                        class="form-control-placeholder">
                                                                        Country</label>
                                                            ...
                                                            <div class="col-12 col-sm-6">
                                                                <div class=" form-label-group mt-2">
                                                                    ...
                                                                    <input type="text" id="post_contact"
                                                                        ...
                                                                        class="form-control" maxlength=""
                                                                        value="<?php echo e($application->current_contact_name); ?>">
                                                                    <label for="contact"
                                                                        class="form-control-placeholder">
                                                                        Receiver's name</label>
                                                            ...
                                                            <div class="col-12 col-sm-6">
                                                                <div class=" form-label-group mt-2">
                                                                    ...
                                                                    <input type="text" id="post_phone"
                                                                        ...
                                                                        placeholder="Receiver's Phone Number"
                                                                        class="form-control" maxlength=""
                                                                        value="<?php echo e($application->current_contact_phone); ?>">
                                                                    <label for="phone"
                                                                        class="form-control-placeholder">
                                                                        Receiver's Phone Number</label>
                                                    ...
                                                    <?php $__currentLoopData = $application->educations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $education): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="form-row form-data">
                                                            <form action=""
                                                                ...
                                                                <div class="pull-right repeater-remove-btn mt-2" style="margin-left: 5px">
                                                                    <button type="button"
                                                                        class="btn btn-secondary remove-btn"
                                                                        onclick="deleteSchool($(this))">
                                                                        Remove
                                        ...
                                        <?php echo $__env->make('Frontend.university.apply-parts.service-panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary-bg ml-auto btn-confirm-free-srv" title="Next">
...
<?php echo $__env->make('Frontend.layouts.master-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rmintern/public_html/resources/views/Frontend/university/apply.blade.php ENDPATH**/ ?>