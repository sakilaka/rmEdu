<?php $__env->startSection('title', '- University Details'); ?>
<?php $__env->startSection('head'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('frontend/studentconnect/css/app.f6cbb5f7.css')); ?>" />
...
<?php $__env->startSection('main_content'); ?>
    <section class="_tps-university">
        ...
        <div class="wrapper">
            ...
            <main>
                <div class="university-header" style="background-image: url('<?php echo e(@$university->banner_image_show); ?>');">
                    <div class="container">
                        <div class="university-header__inner">
                            <div class="university-header__logo-wrapper">
                                <img class="university-header__logo bg-some" src="<?php echo e(@$university->image_show); ?>"
                                    alt="<?php echo e(@$university->name); ?>" title="<?php echo e(@$university->name); ?>" />
                            </div>
                                ...
                                <div>
                                    ...
                                    <ul class="breadcrumbs">
                                        <li class="breadcrumbs__item">
                                            <a href="<?php echo e(route('home')); ?>" class="breadcrumbs__link">
                                                Homepage
                                            </a>
                                        </li>
                                        <li class="breadcrumbs__item">
                                            <a href="<?php echo e(route('frontend.all_universities_list')); ?>"
                ...
                <div class="university-stat-values">
                    <div class="container mx-auto">
                        <div class="row">
                            <?php if($university->stat_values && json_decode($university->stat_values, true)['rank']): ?>
                                <div class="col-6 col-md-3 mt-2 mt-md-0">
                                    <div class="card stat-card">
                                        <div class="card-body">
                                            <h4 class="title fw-bolder">Ranked
                                                #<?php echo e(json_decode($university->stat_values, true)['rank']); ?></h4>
                            ...
                            <?php if($university->stat_values && json_decode($university->stat_values, true)['top_rank_percentage']): ?>
                                <div class="col-6 col-md-3 mt-2 mt-md-0">
                                    <div class="card stat-card">
                                        <div class="card-body">
                                            <h4 class="title fw-bolder">Top
                                                <?php echo e(json_decode($university->stat_values, true)['top_rank_percentage']); ?>%
                                            </h4>
                            ...
                            <?php endif; ?>
                            <?php if($university->stat_values && json_decode($university->stat_values, true)['total_students']): ?>
                                <div class="col-6 col-md-3 mt-2 mt-md-0">
                                    <div class="card stat-card">
                                        <div class="card-body">
                                            <h4 class="title fw-bolder">
                                                <?php echo e(json_decode($university->stat_values, true)['total_students']); ?></h4>
                            ...
                            <?php endif; ?>
                            <?php if($university->stat_values && json_decode($university->stat_values, true)['world_ranking']): ?>
                                <div class="col-6 col-md-3 mt-2 mt-md-0">
                                    <div class="card stat-card">
                                        <div class="card-body">
                                            <h4 class="title fw-bolder">Ranked
                                                <?php echo e(json_decode($university->stat_values, true)['world_ranking']); ?></h4>
                        ...
                        <ul class="nav nav-tabs university-nav__list border-bottom-0" id="universityTab" role="tablist">
                            ...
                            <li class="nav-item university-nav__item" role="presentation">
                                <a class="nav-link university-nav__btn" id="accomodation-tab" data-bs-toggle="tab"
                                    href="#accomodation" role="tab" aria-controls="accomodation"
                                    aria-selected="false">
                                    Accommodation
                                </a>
                            </li>
                        ...
                        <div class="col-md-7 col-lg-8 col-xl-9">
                            <div class="university-body__inner">
                                <div class="tab-content university-body__main" id="myTabContent">
                                    <div class="tab-pane fade show active university-body__section text section"
                                        ...
                                        <div class="university-body__section-inner">
                                            <?php echo $university->overview; ?>

                                        </div>
                                    </div>
                                    <div class="tab-pane fade university-body__section section" id="programs"
                                        role="tabpanel" aria-labelledby="programs-tab">
                                        <h3 class="my-2" style="color: var(--primary_background);font-weight:600;font-size: 18px;line-height: 1.5;margin: 0">Available Degree's</h3>

                                        <div class="university-body__section-inner">
                                            <?php
                                                $degree = \App\Models\Degree::find($university->degree_id);

                                                $departmentData = json_decode($university->department_id, true) ?? [];

                                                $degreeDepartments = [];

                                                foreach ($departmentData as $degreeId => $departmentIds) {
                                                    $degreeName =
                                                        \App\Models\Degree::find($degreeId)?->name ?? 'Unknown Degree';

                                                    $departments = \App\Models\Department::whereIn('id', $departmentIds)
                                                        ->pluck('name')
                                                        ->toArray();

                                                    $degreeDepartments[$degreeName] = $departments;
                                                }
                                            ?>

                                             <div class="row">
                                                <?php $__currentLoopData = $degreeDepartments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $degreeName => $departments): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="col-md-6 mb-3">
                                                        <div class="card shadow-sm border-primary">
                                                            <div class="card-body">
                                                                <h5 class="card-title" style="color: var(--primary_background);">
                                                                    <i class="fas fa-university"></i> <?php echo e($degreeName); ?>

                                                                </h5>
                                                                <div class="card-text d-flex mt-4">
                                                                    <i style="font-size: 16px;" class="fas fa-building"></i>
                                                                    <h6 class="ms-2"><?php echo e(implode(', ', $departments)); ?></h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <?php if(count($university_courses) > 0): ?>
                                        <?php echo $__env->make('Frontend.university.university_courses', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php else: ?>
                                ...
                                <div class="tab-pane fade university-body__section text section" id="scholarships"
                                    ...
                                    <div class="university-body__section-inner">
                                        <?php echo $university->scholarships; ?>
                                ...
                                <div class="tab-pane fade university-body__section text section" id="accomodation"
                                    ...
                                    <div class="university-body__section-inner">
                                        <?php echo $university->accommodation; ?>

                                    </div>
                                </div>
                                <div class="tab-pane fade university-body__section text section" id="admission-process"
                                    role="tabpanel" aria-labelledby="admission-process-tab">
                                    <div>
                                        <h3 class="university-body__section-heading">
                                            Admission Process
                                        </h3>
                                    ...
                                    <div class="university-body__section-inner ckeditor5-rendered">
                                        <?php echo $university->admissions_process; ?>
                                ...
                                <div class="tab-pane fade university-body__section text section" id="location"
                                    ...
                                    <div class="university-body__section-inner">
                                        <div class="row">
                                            ...
                                            ?>
                                            <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $map): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="tab-pane fade university-body__section text section"
                                    id="academic_requirements" role="tabpanel"
                                    aria-labelledby="academic_requirements-tab">
                                    <div>
                                        <h3 class="university-body__section-heading">
                                            Academic Requirements
                                        </h3>
                                    ...
                                    <div class="university-body__section-inner ckeditor5-rendered">
                                        <?php echo $university->academic_requirements; ?>
                                ...
                                <div class="tab-pane fade university-body__section text section" id="english_requirements"
                                    ...
                                    <div class="university-body__section-inner ckeditor5-rendered">
                                        <?php echo $university->english_requirements; ?>
                                ...
                                <div class="tab-pane fade university-body__section text section" id="reviews-section"
                                    ...
                                    <div class="university-body__section-inner">
                                        <div class="">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="rating-point mb-3 text-center">
                                                            <h3 class="display-1 fw-light mb-0 fw-semi-bold"
                                                                ...
                                                                <?php echo e(round(@$university->reviews->avg('ratting'), 1)); ?>
                                                    ...
                                                    <table class="table table-borderless mb-0 white-space-nowrap">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                    ...
                                                                    <div class="rating-percent">
                                                                        <div class="progress">
                                                                            <div class="progress-bar bg-warning progress-bar-striped"
                                                                                role="progressbar"
                                                                                style="width: <?php echo e(@$five_percent); ?>%"
                                                                ...
                                                                <td width="20%" class="align-middle">
                                                                    <div class="user-rating text-muted">
                                                                        <?php echo e(round(@$five_percent), 1); ?>%</div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <?php
                                                                ...
                                                                <td width="70%" class="align-middle">
                                                                    <div class="rating-percent">
                                                                        <div class="progress">
                                                                            <div class="progress-bar bg-warning progress-bar-striped"
                                                                                role="progressbar"
                                                                                style="width: <?php echo e(@$four_percent); ?>%"
                                                                                aria-valuenow="100" aria-valuemin="0"
                                                                                aria-valuemax="100"></div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td width="20%" class="align-middle">
                                                                    <div class="user-rating text-muted">
                                                                        <?php echo e(round(@$four_percent), 1); ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="70%" class="align-middle">
                                                                    <div class="rating-percent">
                                                                        <div class="progress">
                                                                            <div class="progress-bar bg-warning progress-bar-striped"
                                                                                role="progressbar"
                                                                                style="width: <?php echo e(@$three_percent); ?>%"
                                                                ...
                                                                <td width="20%" class="align-middle">
                                                                    <div class="user-rating text-muted">
                                                                        <?php echo e(round(@$three_percent), 1); ?>%</div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <?php
                                                                ...
                                                                <td width="70%" class="align-middle">
                                                                    <div class="rating-percent">
                                                                        <div class="progress">
                                                                            <div class="progress-bar bg-warning progress-bar-striped"
                                                                                role="progressbar"
                                                                                style="width: <?php echo e(@$two_percent); ?>%"
                                                                ...
                                                                <td width="20%" class="align-middle">
                                                                    <div class="user-rating text-muted">
                                                                        <?php echo e(round(@$two_percent), 1); ?>%
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td width="70%" class="align-middle">
                                                                    <div class="rating-percent">
                                                                        <div class="progress">
                                                                            <div class="progress-bar bg-warning progress-bar-striped"
                                                                                role="progressbar"
                                                                                style="width: <?php echo e(@$one_percent); ?>%"
                                                                ...
                                                                <td width="20%" class="align-middle">
                                                                    <div class="user-rating text-muted">
                                                                        <?php echo e(round(@$one_percent), 1); ?>%</div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <div class="row my-3">
                                                <?php $__currentLoopData = $university->reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="col-12 col-sm-auto">
                                                        <div class="avatar d-flex align-items-center">
                                                            <div class="avatar-img me-3">
                                                                <img src="<?php echo e(@$review->user->image_show); ?>"
                                                                    alt="">
                                                            </div>
                                                            <div class="avatar-text">
                                                                <h5 class="avatar-name mb-1">
                                                                    <a href="javascript:void(0)"
                                                                        style="text-decoration:none; color:var(--primary_background)"><?php echo e(@$review->user->name); ?></a>
                                                                </h5>
                                                                ...
                                                                <div class="avatar-text">
                                                                    <div class="rating-input-block">
                                                                        ...
                                                                        <input type="hidden" name="university_id"
                                                                            value="<?php echo e($university->id); ?>">
                                ...
                                <div class="university-aside-item__body">
                                    <div class="university-aside-item__row">
                                        <div class="university-aside-item__cell">
                                            <?php echo e(ucfirst($university->address)); ?> <br>
                                            
                                            
                                            <?php echo e(ucfirst($university->country->name)); ?>,
                                            <?php echo e(ucfirst($university->continent->name)); ?>,
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="university-aside-item">
                                ...
                                <div class="university-aside-item__body text-center">
                                    <button
                                        ...
                                        onclick="window.location.href='<?php echo e(route('frontend.university_course_list')); ?>?university=<?php echo e(@$university->id); ?>'">
                                        Explore Program(s)
                                    </button>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="enquireModal" tabindex="-1" role="dialog" aria-labelledby="enquireModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?php echo e(route('frontend.question')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('frontend/studentconnect/js/runtime.b7ed2637.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/studentconnect/js/730.535b5aff.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/studentconnect/js/app.773d3c55.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('Frontend.layouts.master-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\rminternational-20241015\resources\views/Frontend/university/university_details.blade.php ENDPATH**/ ?>