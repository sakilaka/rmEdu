...
<head>
    ...
    <title><?php echo e(env('APP_NAME')); ?> | Edit Landing Page</title>
</head>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form class="forms-sample"
                                        action="<?php echo e(route('admin.landing_page.update', ['id' => $page->id])); ?>"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input id="title" type="text" name="title" class="form-control"
                                                    placeholder="Enter Title" value="<?php echo e($page->title); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-sm-9 d-flex align-items-center">
                                                <div class="form-check form-check-inline">
                                                    <input id="form_show" type="checkbox" name="form_show"
                                                        ...
                                                        <?php if($page->form_show == 'on'): ?> checked <?php endif; ?>>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea type="text" id="summernote" name="content" class="form-control"><?php echo e($page->content); ?></textarea>
                                            </div>
                                        </div>
...
<?php /**PATH /home/rmintern/public_html/resources/views/Backend/landing_pages/edit.blade.php ENDPATH**/ ?>