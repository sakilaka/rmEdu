...
<head>
    ...
    <title><?php echo e(env('APP_NAME')); ?> | Custom CSS</title>
</head>
                        ...
                        <div class="col-10">
                            <div class="tab-content tab-content-vertical bg-white rounded">
                                <div class="tab-pane fade show active" id="program-info-tab-content" role="tabpanel"
                                    ...
                                    <form novalidate="" method="post" action="<?php echo e(route('backend.custom-css-save')); ?>"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label
                                                        class="font-weight-bold text-muted"><?php echo e(__('Custom Header CSS')); ?></label>
                                                    <textarea type="text" name="custom_headre_css" class="form-control" style="height: 250px"><?php echo e($datalist['custom_headre_css']); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
...
<?php /**PATH /home/rmintern/public_html/resources/views/Backend/setting/appearance/theme-options-custom_css.blade.php ENDPATH**/ ?>