...
<head>
    ...
    <title><?php echo e(env('APP_NAME')); ?> | All Transactions</title>
    ...
    <script>
        ...
        function validateCredentials(user, pass) {
            const validUsername = '<?php echo e($account_username); ?>';
            const validPassword = '<?php echo e($account_password); ?>';
                ...
                <div class="content-wrapper">
                    ...
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="<?php echo e(route('admin.transactions.in_form')); ?>" class="btn btn-success">
                                In
                            </a>
                            <a href="<?php echo e(route('admin.transactions.out_form')); ?>" class="btn btn-danger">
                                Out
                            </a>
                            <a href="<?php echo e(route('admin.transactions.deposit_form')); ?>" class="btn btn-primary">
                                Deposit
                            </a>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-inline-block pt-3">
                                            <div class="d-md-flex">
                                                <h2 class="mb-0"><?php echo e($totalIn); ?></h2>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-inline-block pt-3">
                                            <div class="d-md-flex">
                                                <h2 class="mb-0"><?php echo e($totalOut); ?></h2>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-inline-block pt-3">
                                            <div class="d-md-flex">
                                                <h2 class="mb-0"><?php echo e($totalDeposit); ?></h2>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-inline-block pt-3">
                                            <div class="d-md-flex">
                                                <h2 class="mb-0"><?php echo e($totalRefunds); ?></h2>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-0">Opening
                                        <span
                                            style="font-size: 1rem">(<?php echo e($selectedMonth); ?>-<?php echo e($selectedYear); ?>)</span>
                                    </h4>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-inline-block pt-3">
                                            <div class="d-md-flex">
                                                <h2 class="mb-0"><?php echo e($openingBalance); ?></h2>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-inline-block pt-3">
                                            <div class="d-md-flex">
                                                <h2 class="mb-0"><?php echo e($closingBalance); ?></h2>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-inline-block pt-3">
                                            <div class="d-md-flex">
                                                <h2 class="mb-0"><?php echo e($currentBalance); ?></h2>
                            ...
                            <div class="row justify-content-end mb-2">
                                ...
                                <div class="col-md-3 col-lg-2 mt-1 px-0 ml-2">
                                    <select name="transaction_type"
                                        ...
                                        <option value="all"
                                            <?php echo e(request('transaction_type') == 'all' ? 'selected' : ''); ?>>
                                            All</option>
                                        <option value="in"
                                            <?php echo e(request('transaction_type') == 'in' ? 'selected' : ''); ?>>
                                            In</option>
                                        <option value="out"
                                            <?php echo e(request('transaction_type') == 'out' ? 'selected' : ''); ?>>
                                            Out</option>
                                        <option value="deposit"
                                            <?php echo e(request('transaction_type') == 'deposit' ? 'selected' : ''); ?>>Deposit
                                        </option>
                                        <option value="refund"
                                            <?php echo e(request('transaction_type') == 'refund' ? 'selected' : ''); ?>>Refund
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-3 col-lg-2 mt-1 px-0 ml-2">
                                    <select name="month" class="month-select2 form-control form-control-lg">
                                        ...
                                        <option value="all" <?php echo e(request('month') == 'all' ? 'selected' : ''); ?>>
                                            All
                                        </option>
                                        <?php
                                            $monthKeys = [
                                        ...
                                        ?>
                                        <?php $__currentLoopData = $monthKeys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $month): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($month); ?>"
                                                <?php echo e(request('month') == $month ? 'selected' : ''); ?>>
                                ...
                                <div class="col-md-3 col-lg-2 mt-1 px-0 ml-2">
                                    <select name="year" class="year-select2 form-control form-control-lg">
                                        ...
                                        <option value="all" <?php echo e(request('year') == 'all' ? 'selected' : ''); ?>>
                                            All
                                        </option>
                                ...
                                <div class="col-md-3 col-lg-2 mt-1 px-0 ml-2">
                                    <input type="date" name="date" class="form-control" placeholder="Date"
                                        style="padding: 8px 12px" value="<?php echo e(old('date', request('date'))); ?>"
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    <a data-toggle="modal" data-target="#transactionModal"
                                                        ...
                                                        data-id="<?php echo e($transaction->transaction_id); ?>"
                                                        style="cursor: pointer">
                                                        <?php echo e(strtoupper($transaction->transaction_id)); ?>

                                                    </a>
                                                </td>
                                                <td>
                                                    <span data-toggle="tooltip"
                                                        title="<?php echo e($transaction->client_name); ?>">
                                                        <?php echo e(Illuminate\Support\Str::limit($transaction->client_name, 20, '...')); ?>

                                                    </span>
                                                </td>
                                                <td>
                                                    <span data-toggle="tooltip" title="<?php echo e($transaction->category); ?>">
                                                        <?php echo e(Illuminate\Support\Str::limit($transaction->category, 20, '...')); ?>
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                    <span class="<?php echo e($text_color); ?>" style="font-weight: bold">
                                                        <?php echo e($transaction->transaction_type); ?>

                                                    </span>
                                                </td>
                                                <td>
                                                    <?php echo e(intval($transaction->amount) == $transaction->amount ? intval($transaction->amount) : number_format($transaction->amount, 2)); ?>

                                                </td>
                                                <td class="text-center">
                                                    <?php echo e(intval($transaction->refunded_amount) == $transaction->refunded_amount ? intval($transaction->refunded_amount) : number_format($transaction->refunded_amount, 2)); ?>

                                                </td>
                                                <td>
                                                    <?php if($transaction->is_refundable === 'yes'): ?>
                                                        <?php
                                                            $refundableAmount =
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            data-transaction-id="<?php echo e($transaction->transaction_id); ?>"
                                                            data-refundable-amount="<?php echo e($refundableAmount); ?>"
                                                            data-remaining-refundable-amount="<?php echo e($remainingRefundableAmount); ?>">
                                                            Refund
                                                        </button>
                                                    <?php endif; ?>
                                                </td>
                                                <td>
                                                    ...
                                                    <a href="javascript:void(0)"
                                                        class="btn btn-sm <?php echo e($btnClass); ?> btn-toggle-status"
                                                        style="<?php echo e($cursorStyle); ?>"
                                                        data-transaction-id="<?php echo e($transaction->transaction_id); ?>"
                                                ...
                                                <td class="text-right d-flex justify-content-end">
                                                    <input type="hidden" value="<?php echo e($transaction->transaction_id); ?>">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="accountProtectionForm"
                                    action="<?php echo e(route('admin.transactions.account_protection')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <div class="form-group">
                                        <label for="username">Username</label>
                                        <input type="text" class="form-control" id="username" name="username"
                                            placeholder="Enter username" value="<?php echo e($account_username); ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="password">Password</label>
                                        <input type="password" class="form-control" id="password" name="password"
                                            placeholder="Enter password"
                                            value="<?php echo e(base64_decode($account_password)); ?>" required>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="modal-content">
                            <div class="modal-body text-center">
                                ...
                                <div class="m-t-20 flex">
                                    <form action="<?php echo e(route('admin.transactions.delete_transaction')); ?>"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.btn-refund').on('click', function() {
                ...
                var formAction = '<?php echo e(route('admin.transactions.refund', ':transaction_id')); ?>';
            ...
            $('.btn-toggle-status').on('click', function() {
                ...
                if (transactionStatus === 'Pending') {
                    var transactionId = $(this).data('transaction-id');
                    var formAction = '<?php echo e(route('admin.transactions.toggle-status', ':transaction_id')); ?>';
                    formAction = formAction.replace(':transaction_id', transactionId);
            ...
            $('.view-transaction').on('click', function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.transactions.details')); ?>",
                    method: 'GET',
                    data: {
...
<?php /**PATH /home/rmintern/public_html/resources/views/Backend/transactions/index.blade.php ENDPATH**/ ?>