...
<head>
    ...
    <title><?php echo e(env('APP_NAME')); ?> | All Degree</title>
</head>
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="<?php echo e(route('admin.degree.create')); ?>" class="btn btn-primary btn-fw">
                                    ...
                                    <?php $__currentLoopData = $degrees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="text-center">
                                                <?php
                                                    $department_name = App\Models\Department::where(
                                                        'id',
                                                        $item->department_id,
                                                    )->value('name');
                                                ?>
                                            ...
                                            <td class="text-center">
                                                <?php if($item->status == 1): ?>
                                                    <a href="<?php echo e(route('admin.degree.status', $item->id)); ?>">
                                            ...
                                            <td class="text-right">
                                                <a href="<?php echo e(route('admin.degree.edit', $item->id)); ?>"
                        ...
                        <div class="modal-content">
                            <div class="modal-body text-center">
                                ...
                                <div class="m-t-20 flex">
                                    <form action="<?php echo e(route('admin.degree.delete')); ?>" method="POST" id="deleteForm">
                                        <?php echo csrf_field(); ?>
...
<?php /**PATH /home/rmintern/public_html/resources/views/Backend/courses/degree/index.blade.php ENDPATH**/ ?>