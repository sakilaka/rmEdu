<div class="container" style="margin-top: 2rem">
    ...
    <?php if(session('partner_ref_id') || request()->query('partner_ref_id')): ?>
        <?php
    ...
    <div class="category-banner d-flex align-items-center position-relative overflow-hidden text-white px-4 py-5 px-sm-5 mb-4 text-center"
        ...
        <div class="shadow-inner">
            <div class="bottom-0 end-0 overflow-hidden position-absolute start-0 top-0" style="border-radius: 0.75rem;">
                <img src="<?php echo e($partner ? $partner->user_profile_banner : asset('frontend/images/No-image.jpg')); ?>"
        ...
        <div class="position-relative d-flex justify-content-start align-items-center" style="z-index: 9">
            <div style="width: 7rem;">
                <img src="<?php echo e($partner ? $partner->image_show : asset('frontend/images/no-profile.jpg')); ?>"
            ...
            <div style="margin-left: 2rem">
                <?php if($partner): ?>
                    ...
                    ?>
                    <div>
                        <h2 style="font-size: 2rem; font-weight:700;"><?php echo e($partner->name); ?></h2>
                        <p class="text-start" style="font-size: 1rem">
                            <?php echo e($partner->address ? $partner->address . ',' : ''); ?>

                            <?php echo e($country ? $country->name . ',' : ''); ?>

                            <?php echo e($partner->continents->name ?? ''); ?>
                    ...
                    <div>
                        ...
                        <div class="d-flex align-items-center justify-content-start mt-2 footer_social_container">
                            <a class="footer_social_icons_container" target="_blank"
                                href="<?php echo e($partner->facebook_url ?? '#'); ?>" style="margin-left: 0 !important;">
                            ...
                            <a class="footer_social_icons_container" target="_blank"
                                href="<?php echo e($partner->twitter_url ?? '#'); ?>" style="margin-left: 0 !important;">
                            ...
                            <a class="footer_social_icons_container" target="_blank"
                                href="<?php echo e($partner->instagram_url ?? '#'); ?>">
                                <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
...
<?php /**PATH C:\laragon\www\rminternational-20241015\resources\views/Frontend/layouts/parts/partner_profile_banner.blade.php ENDPATH**/ ?>