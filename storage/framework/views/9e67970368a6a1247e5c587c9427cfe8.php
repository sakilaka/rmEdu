...
<div class="bg-alice-blue py-4" id="faq">
    <div class="container-lg">
        ...
        <div class="section-header mb-4">
            ...
            <span class="m-1"><?php echo e($faq_content->description2); ?></span>
        </div>
        <!--End Section Header-->
...
<?php echo $__env->make('Frontend.layouts.master-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rmintern/public_html/resources/views/Frontend/pages/faq.blade.php ENDPATH**/ ?>