...
<head>
    ...
    <title><?php echo e(env('APP_NAME')); ?> | Add Admin</title>
</head>
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="<?php echo e(route('backend.manage_admin')); ?>" class="btn btn-primary btn-fw">
                    ...
                    <div class="row">
                        <div class="col-md-9 m-auto grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <form class="forms-sample" action="<?php echo e(route('backend.store_admin')); ?>"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-3 d-flex justify-content-between align-items-center">
                                                <label for="city_name" class=" col-form-label">Email
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <p>:</p>
                                            </div>
                                            <div class="col-sm-9">
                                                <input type="email" name="email" class="form-control"
                                                    placeholder="Enter Email" autocomplete="new-email" required>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-3 d-flex justify-content-between align-items-center">
                                                <label for="city_name" class=" col-form-label">Password
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <p>:</p>
                                            </div>
...
<?php /**PATH /home/rmintern/public_html/resources/views/Backend/all_users/admin/create.blade.php ENDPATH**/ ?>