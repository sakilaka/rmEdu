        ...
        <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                    ...
                    <div class="dropdown-item">
                        ...
                        <a href="<?php echo e(route('admin.all.notification.index')); ?>"
                    ...
                    <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($notification->type == 'university'): ?>
                            <a href="<?php echo e(route('admin.student_appliction_details', $notification->application->id ?? '')); ?>"
                                class="preview-item">
            ...
            <li class="nav-item nav-profile dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
                    <a class="dropdown-item" href="<?php echo e(route('backend.edit_admin', Auth::user()->id)); ?>">
...
<?php /**PATH C:\laragon\www\rminternational-20241015\resources\views/Backend/components/navbar.blade.php ENDPATH**/ ?>