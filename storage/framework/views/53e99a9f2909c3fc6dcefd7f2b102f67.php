                            ...
                            <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-sm-6 col-lg-4 px-22">
                                    <div class="choose_inner">
                                        <img src="<?php echo e($faq->image_show); ?>"class="img-fluid w-100" alt="">

                                        <div class="shadow p-4 bg-alice-blue w-100 rounded">
                                            <p class="mb-0" style="color:var(--text_color)"><?php echo $faq->description; ?></p>
                                        </div>
...
<?php echo $__env->make('Frontend.layouts.master-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rmintern/public_html/resources/views/Frontend/pages/about.blade.php ENDPATH**/ ?>