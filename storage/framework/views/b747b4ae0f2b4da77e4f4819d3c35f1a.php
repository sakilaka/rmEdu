...
<head>
    ...
    <title><?php echo e(env('APP_NAME')); ?> | All Category</title>
</head>
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="<?php echo e(route('home-category.create')); ?>" class="btn btn-primary btn-fw">
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="text-center">
                                                <?php if($item->status == 1): ?>
                                                    <a href="<?php echo e(route('home-category.status_toggle',$item->id)); ?>">
                                            ...
                                            <td class="text-right">
                                                <a href="<?php echo e(route('home-category.edit', $item->id)); ?>"
                        ...
                        <div class="modal-content">
                            <div class="modal-body text-center">
                                ...
                                <div class="m-t-20 flex">
                                    <form action="<?php echo e(route('home-category.delete')); ?>" method="POST" id="deleteForm">
                                        <?php echo csrf_field(); ?>
...
<?php /**PATH /home/rmintern/public_html/resources/views/Backend/home/category/index.blade.php ENDPATH**/ ?>