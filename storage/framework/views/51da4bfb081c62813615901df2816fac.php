                        ...
                        <div class="my-2">
                            ...
                            <div class="toggle-content" data-filters="university">
                                <select name="university" class="form-control select2_form_select" style="width: 90%;">
                                    ...
                                    <?php $__currentLoopData = $univerties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $university): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($university->id); ?>"
                                            <?php echo e(request()->get('university') == $university->id ? 'selected' : ''); ?>>
                ...
                <div class="column is-9">
                    ...
                    <div class="all_courses_container">
                        ...
                        <div class="onSearchResultPage">
                            <div id="programsFoundCount" style="display:none"><?php echo e($courses->count()); ?> Programs Found
                            </div>
                                                ...
                                                <div class="choice s-col-11 search-page-list-item">
                                                    <div class="choice-wrapper" data-url="<?php echo e($course_details_url); ?>">
                                                        ...
                                                        <div class="s-row">
                                                            <div class="s-col-9">
                                                                <a href="<?php echo e($course_details_url); ?>" class="">
                                                                    ...
                                                                    <p class="school-name-desktop">
                                                                        <?php echo e(@$course->university->name); ?></p>
                                                                    ...
                                                                    <div class="wrapper-bullts">
                                                                        ...
                                                                        <div class="bulit">
                                                                            ...
                                                                            <div class="value">
                                                                                <?php echo e(@$course->course_duration); ?> Year</div>
                                                                        </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="d-flex justify-content-center mb-2">
                                                                    <section
                                                                        ...
                                                                        <button
                                                                            class="ca-button btn-primary-bg justify-content-center">
                                                            ...
                                                            <div class="d-md-none s-col-12 mb-3">
                                            ...
                                            <div class="pagination">
                                                ...
                                                <?php for($i = 1; $i <= $courses->lastPage(); $i++): ?>
                                                    <a class="pagination-link course-paginate page current <?php if($i == $courses->currentPage()): ?> is-current <?php endif; ?>"
                                                        ...
                                                        <?php if($i == $courses->currentPage()): ?>  <?php endif; ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        $(document).on('click', '.clear-filter', function() {
            $('.filterTags').remove();
            window.location.href = '<?php echo e(route('frontend.university_course_list')); ?>';
            $('.clear-filter').css('display', 'none');
        })
    ...
    <script>
        function filterCourse(del_filter = false, page = 1) {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('ajax-course-filter')); ?>",
                data: data_val,
        ...
        $(".on_click_university_degree").change(function(e) {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('get-university-course-degree')); ?>/" + id,
        ...
        $('body').on("click", '.sort_category_course_list', function() {
            ...
            let url = '<?php echo e(url('get-sort-course-list/')); ?>/' + cat;
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('get-sort-course-list')); ?>/" + cat,
                success: function(data) {
                    $('.preloader_container').removeClass('d-inline-block').addClass('d-none');
                    $(".all_courses_container").append(data);
                },
        ...
        $(".continent_course_list").change(function(e) {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('get-continent-course-list')); ?>/" + id,
                success: function(data) {
        ...
        $(".country_course_list").change(function(e) {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('get-country-course-list')); ?>/" + id,
                success: function(data) {
        ...
        $(".state_course_list").change(function(e) {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('get-state-course-list')); ?>/" + id,
                success: function(data) {
        ...
        $(".city_course_list").change(function(e) {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('get-city-course-list')); ?>/" + id,
                success: function(data) {
...
<?php echo $__env->make('Frontend.layouts.master-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rmintern/public_html/resources/views/Frontend/university/university_course_list.blade.php ENDPATH**/ ?>