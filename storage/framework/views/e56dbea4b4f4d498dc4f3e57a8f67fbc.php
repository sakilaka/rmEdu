    ...
    <script>
        document.getElementById('agreeBtn').addEventListener('click', function(event) {
            ...
            if (!checkbox.checked) {
                ...
                window.location.href = "<?php echo e($apply_url); ?>";  
            }
        });
    </script>
...
<?php echo $__env->make('Frontend.layouts.master-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\rminternational-20241015\resources\views/Frontend/university/terms.blade.php ENDPATH**/ ?>