...
<head>
    ...
    <title><?php echo e(env('APP_NAME')); ?> | Edit Admin</title>
</head>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form class="forms-sample"
                                        action="<?php echo e(route('backend.update_admin', ['id' => $admin->id])); ?>"
                                            ...
                                            <div class="col-sm-9">
                                                <div class="row">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="px-3">
                                                            <img src="<?php echo e($admin->image_show ?? asset('frontend/images/No-image.jpg')); ?>"
                                                                alt="" class="img-fluid"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="name" class="form-control"
                                                    placeholder="Enter Admin Name" value="<?php echo e($admin->name); ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="mobile" class="form-control"
                                                    placeholder="Enter Mobile Number" value="<?php echo e($admin->mobile); ?>"
                                                    required>
                                            </div>
                                        </div>
...
<?php /**PATH /home/rmintern/public_html/resources/views/Backend/all_users/admin/update.blade.php ENDPATH**/ ?>