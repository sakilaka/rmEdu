...
<?php $__env->startSection('main_content'); ?>
    ...
    <div class="content_search" style="margin-top:70px">
            ...
            <div class="container-xl">
                <div class="row justify-content-center">
                    ...
                    <div class="col-12">
                        ...
                        <div class="category-banner shadow-inner position-relative text-white px-4 py-5 px-sm-5 mb-4 text-center"
                            ...
                            <div class="bottom-0 end-0 overflow-hidden position-absolute start-0 top-0"
                                ...
                                <img src="<?php echo e(@$event->image_show); ?>" class="img-fluid wh_sm_100" alt=""
                    ...
                    <div class="col-lg-8">
                        ...
                        <h4 class="fs-4 fw-bold my-4" style="color: var(--button_primary_light_bg)"><?php echo e($event->name); ?></h4>

                        <div class="d-xl-flex">
                            <h6 class="fw-semi-bold text_bluish-black mb-0">
                                <i class="fa fa-calendar" aria-hidden="true"></i>
                                <?php echo e(date('d F Y', strtotime($event->startdate))); ?>
                        ...
                        <div class="d-block my-4">
                            <img src="<?php echo e($event->host->image_show ?? ''); ?>" class="img-fluid" alt="">
                        </div>
                        <div class="d-flex flex-wrap justify-content-xl-between mb-4 text-muted">
                            <div class="d-block neat_block px-5 py-3 rounded-1 my-1 me-2 me-xl-0 text-center font_open">
                                ...
                                <div class="fs-6 fw-bold">
                                    <?php echo e($event->eventschedules->groupBy('instrutor_id')->count()); ?>

                                </div>
                            </div>
                            <div class="d-block neat_block px-5 py-3 rounded-1 my-1 me-2 me-xl-0 text-center font_open">
                                <div class="fs-6 fw-semi-bold mb-2 title">Sessions</div>
                                <div class="fs-6 fw-bold"><?php echo e($event->eventschedules->count()); ?></div>
                            </div>
                            <div class="d-block neat_block px-5 py-3 rounded-1 my-1 me-2 me-xl-0 text-center font_open">
                        ...
                        <div
                            ...
                            <div class="align-items-center d-flex justify-content-between">
                                ...
                                <h5 class="p-2"><b> $<?php echo e(format_price(@$event->fee)); ?></b></h5>
        ...
        <?php if($event->courselearns->count() > 0): ?>
                            ...
                            <div class="card border-0 rounded-0 shadow-sm">
                                <div class="card-body p-3 p-sm-4">
                                    <ul class="list-unstyled mb-0">
                                        <?php $__currentLoopData = $event->courselearns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $courselearn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="my-1">
                                                ...
                                                <span class="ms-2"><?php echo e(@$courselearn->name); ?></span>
                                            </li>
        ...
        <?php if($event->courserequisites->count() > 0): ?>
            <!--Start Requirements -->
            <div class="bg-alice-blue pt-5" style="color: var(--text_color)">
                <div class="container-xl">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            ...
                            <div class="card border-0 rounded-0 shadow-sm">
                                <div class="card-body p-3 p-sm-4">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        <?php $__currentLoopData = $event->courserequisites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $courserequisite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="my-1">
                                                <svg width="21" height="22" viewBox="0 0 21 22" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <rect x="0.447754" y="0.99292" width="20.28" height="20.28"
                                                ...
                                                <span class="ms-2"> <?php echo e(@$courserequisite->name); ?></span>
                                            </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                </div>
            ...
            <div class="container-xl">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        ...
                        <?php $__currentLoopData = $event->eventschedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eventschedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="bg-white d-block shadow-sm p-5 event_comment-block mb-4">
                                <div class="d-flex align-items-center mb-4">
                                    <div class="img-user width_55p">
                                        <img src="<?php echo e(@$eventschedule->instrutor->image_show); ?>"
                                            class="rounded-circle img-fluid" alt="">

                                    </div>

                                    <div class="ms-3">
                                        <h6 class="fs-5 fw-semi-bold mb-1"><?php echo e(@$eventschedule->instrutor->name); ?></h6>
                                        <p class="fs-15 mb-2 text-muted">
                                            <?php echo e(@$eventschedule->instrutor->continents->name); ?>.</p>
                                        <div class="d-xl-flex">
                                ...
                                <div class="font_open fs-5 text-muted mb-0 text_ellipse2 ">
                                    <?php echo @$eventschedule->instrutor->description; ?>
                                    ...
                                    <div class="d-block my-0.5">
                                        <div
                                            ...
                                            <div class="d-block me-5 cLast br-dc">
                                                <?php if($eventschedule->day_id == '1'): ?>
                                                    Day 1
                                                <?php elseif($eventschedule->day_id == '2'): ?>
                                                    Day 2
                                                <?php elseif($eventschedule->day_id == '3'): ?>
                                                    Day 3
                                                <?php elseif($eventschedule->day_id == '4'): ?>
                                                    Day 4
                                                <?php elseif($eventschedule->day_id == '5'): ?>
                                                    Day 5
                                                <?php elseif($eventschedule->day_id == '6'): ?>
                                                    Day 6
                                                <?php elseif($eventschedule->day_id == '7'): ?>
                                                    Day 7
                                                <?php elseif($eventschedule->day_id == '8'): ?>
                                                    Day 8
                                                <?php elseif($eventschedule->day_id == '9'): ?>
                                                    Day 9
                                                <?php elseif($eventschedule->day_id == '10'): ?>
                                                    Day 10
                                                <?php elseif($eventschedule->day_id == '11'): ?>
                                                    Day 11
                                                <?php elseif($eventschedule->day_id == '12'): ?>
                                                    Day 12
                                                <?php elseif($eventschedule->day_id == '13'): ?>
                                                    Day 13
                                                <?php elseif($eventschedule->day_id == '14'): ?>
                                                    Day 14
                                                <?php elseif($eventschedule->day_id == '15'): ?>
                                                    Day 15
                                                <?php elseif($eventschedule->day_id == '16'): ?>
                                                    Day 16
                                                <?php elseif($eventschedule->day_id == '17'): ?>
                                                    Day 17
                                                <?php elseif($eventschedule->day_id == '18'): ?>
                                                    Day 18
                                                <?php elseif($eventschedule->day_id == '19'): ?>
                                                    Day 19
                                                <?php elseif($eventschedule->day_id == '20'): ?>
                                                    Day 20
                                                <?php elseif($eventschedule->day_id == '21'): ?>
                                                    Day 21
                                                <?php elseif($eventschedule->day_id == '22'): ?>
                                                    Day 22
                                                <?php elseif($eventschedule->day_id == '23'): ?>
                                                    Day 23
                                                <?php elseif($eventschedule->day_id == '24'): ?>
                                                    Day 24
                                                <?php elseif($eventschedule->day_id == '25'): ?>
                                                    Day 25
                                                <?php elseif($eventschedule->day_id == '26'): ?>
                                                    Day 26
                                                <?php elseif($eventschedule->day_id == '27'): ?>
                                                    Day 27
                                                <?php elseif($eventschedule->day_id == '28'): ?>
                                                    Day 28
                                                <?php elseif($eventschedule->day_id == '29'): ?>
                                                    Day 29
                                                <?php elseif($eventschedule->day_id == '30'): ?>
                                                    Day 30
                                                <?php elseif($eventschedule->day_id == '31'): ?>
                                                    Day 31
                                                <?php endif; ?>
                                            </div>

                                            <div class="d-block">
                                                <?php echo e(date('d,F,Y', strtotime(@$eventschedule->scheduledate))); ?></div>
                                        </div>
                                        <div class="border-dc fs-6 fw-bold px-3 py-2">
                                            <div class="d-sm-flex align-items-center mb-1">
                                                <div class="d-block me-5 cLast br-dc">

                                                    <?php echo e(date('h:i A', strtotime(@$eventschedule->startdate))); ?>-<?php echo e(date('h:i A', strtotime($eventschedule->enddate))); ?>

                                                </div>
                                                <div class="d-block"><?php echo @$eventschedule->schedulename; ?> : Class <?php echo e($i++); ?>

                                                </div>
                                            </div>
                                            <div class="d-block fw-light text-muted">
                                                <?php echo e(@$eventschedule->instrutor->name); ?></div>
                                        </div>
                                    </div>
            ...
            <div class="container-xl">
                <div class="justify-content-center row">
                    <div class="col-lg-8">
                        ...
                        <form action="<?php echo e(route('event.details.massage')); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        function makeTimer() {
            ...
            var countdowntime = "<?php echo e(date('d F Y H:i:s', strtotime($event->startdate))); ?>";
...
<?php echo $__env->make('Frontend.layouts.master-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rmintern/public_html/resources/views/Frontend/pages/eventdetails.blade.php ENDPATH**/ ?>