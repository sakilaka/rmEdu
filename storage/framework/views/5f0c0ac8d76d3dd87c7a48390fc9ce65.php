...
<?php $__env->startSection('main_content'); ?>
    ...
    <div class="content_search" style="margin-top:70px">
        ...
        <!-- <link href="" rel="stylesheet"> -->
        <link rel="stylesheet"
            href="<?php echo e(asset('frontend')); ?>/application/modules/frontend/views/themes/default/assets/css/ali.css">
        <link rel="stylesheet"
            href="<?php echo e(asset('frontend')); ?>/application/modules/frontend/views/themes/default/assets/css/blog.css">
        <script src="#"></script>
                    ...
                    <div class="col-md-12 px-0">
                        ...
                        <div class="category-banner shadow-inner bg-img text-white px-4 py-5 px-sm-5 position-relative">
                            <div class="bottom-0 end-0 overflow-hidden position-absolute start-0 top-0"
                                style="background-image: url('<?php echo e($blog->image_show); ?>');border-radius:0.75rem;background-position: center;background-repeat: no-repeat;background-size: cover;">
                                        ...
                                        <div class="d-block">
                                            ...
                                            <div class="d-flex mt-4">
                                                ...
                                                <div class="vSec" style="color: var(--header_text_color)">
                                                    <?php echo e($blog->b_category->name ?? ''); ?></div>
                ...
                <div class="bg-white rounded justify-content-center row">
                    <div class="col-xl-8 pt-5 blog-des-area">
                        ...
                        <div class="align-items-center d-flex flex-wrap tags mt-5 mb-4">
                            ...
                            <?php $__currentLoopData = $blog->tag; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="bg-white border d-inline-block fs-6 me-2 my-1 px-3 py-2 rounded shadow-sm"
                                    style="color: var(--text_color)">#<?php echo e($item->name); ?></span>
                        ...
                        <div class="align-items-center border-top justify-content-between mx-0 py-4 row alabin">
                            <div class="col-lg-6">
                                <div class="align-items-center avatar d-flex mb-4 mb-lg-0">
                                    <div class="blog me-4">
                                        <img src="<?php echo e($blog->author_image_show); ?>" alt=""
                                ...
                                <div
                                    ...
                                    <div class="align-items-center d-flex me-3 me-md-5 vBlog_soc" style="cursor: pointer;">
                                        <div class="likeunlike-area">
                                            <?php if(auth()->guard()->check()): ?>
                                                <?php if(auth()->user()->likedBlogs->contains($blog)): ?>
                                                    
                                                    <button class="like-btn border-0" data-blog-id="<?php echo e($blog->id); ?>">
                                        ...
                                        <span class="ms-2 fs-5" style="color: var(--text_color)">Like :
                                            <?php echo e($blog->likers->count()); ?></span>
                                    ...
                                    <div class="align-items-center d-flex me-3 me-md-5 vBlog_soc">
                                        ...
                                        <span class="ms-2 fs-5"
                                            style="color: var(--text_color)"><?php echo e($blog->views); ?></span>
                                    </div>
                                    <div class="align-items-center d-flex me-3 me-md-5 vBlog_soc">
                                        ...
                                        <span class="ms-2 fs-5" style="color: var(--text_color)">
                                            <?php echo e($blog->comments->count()); ?></span>
                                    </div>
                        ...
                        <div class="vBlog-carousel owl-carousel">
                            <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="p-5" style="background-color: rgb(255, 255, 255); border:0.5px solid #eee; border-radius:0.5rem;">
                                    <a href="<?php echo e(route('frontend.blog_details', $item->id)); ?>" class=""
                                        style="color: var(--button_primary_light_bg); z-index:11">
                                        <img src="<?php echo e($item->image_show); ?>" alt=""
                    ...
                    <div class="col-xl-10">
                        <div class="card border-0 rounded-0 mb-3">
                            <div class="card-body py-0">
                                ...
                                <form action="<?php echo e(route('frontend.blog_comment')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                        ...
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <div class="ms-3">
                                                <h6 class="mb-1 fs-5" style="color: var(--text_color)">
                                                    <?php echo e($comment->user->name ?? ''); ?></h6>
        ...
        <script>
            $(document).ready(function() {
                ...
                function toggleLike(blogId, arg) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo e(url('blog_like/')); ?>/' + blogId + '/toggle-like',
                        headers: {
...
<?php echo $__env->make('Frontend.layouts.master-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rmintern/public_html/resources/views/Frontend/pages/blog_details.blade.php ENDPATH**/ ?>