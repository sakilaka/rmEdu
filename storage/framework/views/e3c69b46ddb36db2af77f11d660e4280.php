              ...
              <section class="" id="optional-services">
                  ...
                  <div class="custom-control custom-radio">
                      ...
                      <label class="custom-control-label" for="none">
                          <strong>
                              No, thanks (Basic Service) - $<?php echo e($application->application_fee); ?>
                      ...
                      <small>
                          <p style="text-align:initial">
                              ✓&nbsp;<b>Price Match</b> - $<span
                                  class="app-fee"><?php echo e($application->application_fee); ?></span> USD is the university
...
<?php /**PATH C:\laragon\www\rminternational-20241015\resources\views/Frontend/university/apply-parts/service-panel.blade.php ENDPATH**/ ?>