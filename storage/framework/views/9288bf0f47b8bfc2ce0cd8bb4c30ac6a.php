<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item <?php echo e($is_active_transactions ? 'active' : ''); ?>">
        ...
        ?>
        <li class="nav-item <?php echo e($is_active_home ? 'active' : ''); ?>">
            ...
            <div class="collapse <?php echo e($is_active_home ? 'show' : ''); ?>" id="home-sidemenu">
                <ul class="nav flex-column sub-menu">
                    
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('admin.manage_menu')); ?>"
                            class="nav-link <?php echo e(Route::is('admin.manage_menu') || Route::is('admin.create_menu') || Route::is('admin.edit_menu') ? 'active' : ''); ?>">
                    ...
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('home-category.index')); ?>"
                            class="nav-link <?php echo e(Route::is('home-category.index') || Route::is('home-category.create') || Route::is('home-category.edit') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-3" aria-hidden="true"></i>
                            Category
                        </a>
                    </li>
                    ...
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('home-sub-category.index')); ?>"
                            class="nav-link <?php echo e(Route::is('home-sub-category.create') || Route::is('home-sub-category.index') || Route::is('home-sub-category.edit') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-3" aria-hidden="true"></i>
                            Sub Category
                        </a>
                    </li>
        ...
        ?>
        <li class="nav-item <?php echo e($is_active_program_module ? 'active' : ''); ?>">
            ...
            <div class="collapse <?php echo e($is_active_program_module ? 'show' : ''); ?>" id="program-sidemenu">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item d-lg-block">
                        <a href="<?php echo e(route('admin.u_course.index')); ?>"
                            class="nav-link <?php echo e($is_active_program_sub_module ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-3" aria-hidden="true"></i>
                            Programs
                        </a>
                    </li>
                    ...
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('admin.department.index')); ?>"
                            class="nav-link <?php echo e($is_active_department_sub_module ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-3" aria-hidden="true"></i>
                            Department
                        </a>
                    </li>
                    ...
                    ?>
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('admin.degree.index')); ?>"
                            class="nav-link <?php echo e($is_active_degree_sub_module ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-3" aria-hidden="true"></i>
                            Degree
                        </a>
                    </li>
                    ...
                    ?>
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('admin.section.index')); ?>"
                            class="nav-link <?php echo e($is_active_section_sub_module ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-3" aria-hidden="true"></i>
                            Section
                        </a>
                    </li>
                    ...
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('admin.language.index')); ?>"
                            class="nav-link <?php echo e($is_active_language_sub_module ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-3" aria-hidden="true"></i>
                            Language
                        </a>
                    </li>
        ...
        ?>
        <li class="nav-item <?php echo e($is_active_all_applications ? 'active' : ''); ?>">
            ...
            <div class="collapse <?php echo e($is_active_all_applications ? 'show' : ''); ?>" id="all-application-sidemenu">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item d-none d-lg-block">
                        <?php
                        ...
                        <a href="<?php echo e(route('admin.student_appliction_list')); ?>"
                            class="nav-link <?php echo e($program_application_routes ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-3" aria-hidden="true"></i>
                            All Applications
                        </a>
                    </li>
                    ...
                    <li class="nav-item d-none d-lg-block">
                        <?php
                            $program_application_routes_grouping =
                                Route::is('admin.student_appliction_list_grouping');
                        ?>
                        <a href="<?php echo e(route('admin.student_appliction_list_grouping')); ?>"
                            class="nav-link <?php echo e($program_application_routes_grouping ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-3" aria-hidden="true"></i>
                    ...
                    <li class="nav-item d-none d-lg-block">
                        ...
                        <a href="<?php echo e(route('admin.student_appliction_list_partner_wise')); ?>"
                            class="nav-link <?php echo e($partner_wise_student_application_routes ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-3" aria-hidden="true"></i>
        ...
        ?>
        <li class="nav-item <?php echo e($is_active_inquiry ? 'active' : ''); ?>">
            <a class="nav-link" href="<?php echo e(route('admin.inquiry.index')); ?>">
        ...
        ?>
        <li class="nav-item <?php echo e($is_active_university ? 'active' : ''); ?>">
            ...
            <div class="collapse <?php echo e($is_active_university ? 'show' : ''); ?>" id="university-sidemenu">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('admin.university.index')); ?>"
                            class="nav-link <?php echo e(Route::is('admin.university.index') || Route::is('admin.university.create') || Route::is('admin.university.edit') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-3" aria-hidden="true"></i>
                            Manage University
                        </a>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('admin.university_faq_manage')); ?>"
                            class="nav-link <?php echo e(Route::is('admin.university_faq_manage') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-3" aria-hidden="true"></i>
                            University FAQ
                        </a>
                    </li>
        ...
        <?php
            $is_active_location =
                ...
                Route::is('city.index');
        ?>
        <li class="nav-item <?php echo e($is_active_location ? 'active' : ''); ?>">
            ...
            <div class="collapse <?php echo e($is_active_location ? 'show' : ''); ?>" id="location-sidemenu">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('continent.index')); ?>"
                            class="nav-link <?php echo e(Route::is('continent.index') || Route::is('continent.create') || Route::is('continent.edit') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-3" aria-hidden="true"></i>
                            Continents
                        </a>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('country.index')); ?>"
                            class="nav-link <?php echo e(Route::is('country.index') || Route::is('country.create') || Route::is('country.edit') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-3" aria-hidden="true"></i>
                            Countries
                        </a>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('state.index')); ?>"
                            class="nav-link <?php echo e(Route::is('state.index') || Route::is('state.create') || Route::is('state.edit') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-3" aria-hidden="true"></i>
                            States
                        </a>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('city.index')); ?>"
                            class="nav-link <?php echo e(Route::is('city.index') || Route::is('city.create') || Route::is('city.edit') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-3" aria-hidden="true"></i>
                            Cities
                        </a>
                    </li>
        ...
        ?>
        <li class="nav-item <?php echo e($is_active_users ? 'active' : ''); ?>">
            ...
            <div class="collapse <?php echo e($is_active_users ? 'show' : ''); ?>" id="all-user-sidemenu">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('backend.manage_admin')); ?>"
                            class="nav-link <?php echo e(Route::is('backend.manage_admin') || Route::is('backend.create_admin') || Route::is('backend.edit_admin') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-3" aria-hidden="true"></i>
                            Manage Admins
                        </a>
                    </li>
                    ...
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('admin.student.index')); ?>"
                            class="nav-link <?php echo e(Route::is('admin.student.index') || Route::is('admin.student.create') || Route::is('admin.student_details') || Route::is('admin.student.edit') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-3" aria-hidden="true"></i>
                            Manage Student
                        </a>
                    </li>
                    ...
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('admin.consultant.index')); ?>"
                            class="nav-link <?php echo e(Route::is('admin.consultant.index') || Route::is('admin.consultant.create') || Route::is('admin.consultant.edit') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-3" aria-hidden="true"></i>
                            Manage Partner
                        </a>
                    </li>
        ...
        ?>
        <li class="nav-item <?php echo e($is_active_testimonial ? 'active' : ''); ?>">
            ...
            <div class="collapse <?php echo e($is_active_testimonial ? 'show' : ''); ?>" id="testimonials-sidemenu">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('admin.manage_testimonial')); ?>"
                            class="nav-link <?php echo e(Route::is('admin.manage_testimonial') || Route::is('admin.add_new_testimonial') || Route::is('admin.edit_testimonial') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-2" aria-hidden="true"></i>
                            Manage Testimonials
                        </a>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('admin.review.index')); ?>"
                            class="nav-link <?php echo e(Route::is('admin.review.index') || Route::is('admin.review.edit') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-2" aria-hidden="true"></i>
                            Manage Review
                        </a>
                    </li>
        ...
        ?>
        <li class="nav-item <?php echo e($is_active_blog ? 'active' : ''); ?>">
            ...
            <div class="collapse <?php echo e($is_active_blog ? 'show' : ''); ?>" id="blogs-events-sidemenu">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('admin.event.index')); ?>"
                            class="nav-link <?php echo e(Route::is('admin.event.index') || Route::is('admin.event.create') || Route::is('admin.event.edit') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-2" aria-hidden="true"></i>
                            Manage Event
                        </a>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('admin.event.order.manage')); ?>"
                            class="nav-link <?php echo e(Route::is('admin.event.order.manage') || Route::is('event.order.details') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-2" aria-hidden="true"></i>
                            Event Participant
                        </a>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('admin.event.contact.index')); ?>"
                            class="nav-link <?php echo e(Route::is('admin.event.contact.index') || Route::is('admin.event.contact.edit') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-2" aria-hidden="true"></i>
                            Event Comment
                        </a>
                    </li>
                    ...
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('blog.manage_topic')); ?>"
                            class="nav-link <?php echo e(Route::is('blog.manage_topic') || Route::is('blog.create_topic') || Route::is('blog.edit_topic') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-2" aria-hidden="true"></i>
                            Manage Topic
                        </a>
                    </li>
                    ...
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('blog.index')); ?>"
                            class="nav-link <?php echo e(Route::is('blog.index') || Route::is('blog.create') || Route::is('blog.edit') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-2" aria-hidden="true"></i>
                            Manage Blog
                        </a>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('blog.comments')); ?>"
                            class="nav-link <?php echo e(Route::is('blog.comments') || Route::is('blog.comment_edit') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-2" aria-hidden="true"></i>
        ...
        ?>
        <li class="nav-item <?php echo e($is_active_subscriber ? 'active' : ''); ?>">
        ...
        ?>
        <li class="nav-item <?php echo e($is_active_contact ? 'active' : ''); ?>">
            <a class="nav-link" href="<?php echo e(route('user.contact.index')); ?>">
        ...
        ?>
        <li class="nav-item <?php echo e($is_active_notification ? 'active' : ''); ?>">
            <a class="nav-link" href="<?php echo e(route('admin.all.notification.index')); ?>">
        ...
        ?>
        <li class="nav-item <?php echo e($is_active_appearance ? 'active' : ''); ?>">
            ...
            <div class="collapse <?php echo e($is_active_appearance ? 'show' : ''); ?>" id="appearance-sidemenu">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item d-none d-lg-block">
                        <?php
                            $is_active_appearance_theme_option =
                                ...
                                Route::is('backend.theme-options-payment-gateway');
                        ?>
                        <a href="<?php echo e(route('backend.theme-options')); ?>"
                            class="nav-link <?php echo e($is_active_appearance_theme_option ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-2" aria-hidden="true"></i>
                            Theme option
                        </a>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('backend.home_content')); ?>"
                            class="nav-link <?php echo e(Route::is('backend.home_content') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-2" aria-hidden="true"></i>
                            Home Content Setup
                        </a>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('home-banner.index')); ?>"
                            class="nav-link <?php echo e(Route::is('home-banner.index') || Route::is('home-banner.create') || Route::is('home-banner.edit') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-2" aria-hidden="true"></i>
                            Manage Banner
                        </a>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('all-pages.index')); ?>"
                            class="nav-link <?php echo e(Route::is('all-pages.index') || Route::is('all-pages.create') || Route::is('all-pages.edit') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-2" aria-hidden="true"></i>
                            Manage Pages
                        </a>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                        <?php
                            $is_active_other_pages =
                                ...
                                Route::is('admin.manage_faq');
                        ?>
                        <a href="<?php echo e(route('admin.about_page')); ?>"
                            class="nav-link <?php echo e($is_active_other_pages ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-2" aria-hidden="true"></i>
                            Other Pages
                        </a>
                    </li>
        ...
        ?>
        <li class="nav-item <?php echo e($is_active_landing_page ? 'active' : ''); ?>">
            ...
            <div class="collapse <?php echo e($is_active_landing_page ? 'show' : ''); ?>" id="landing-page-sidemenu">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('admin.landing_page.index')); ?>"
                            class="nav-link <?php echo e(Route::is('admin.landing_page.index') || Route::is('admin.landing_page.create') || Route::is('admin.landing_page.edit') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-2" aria-hidden="true"></i>
                            Manage Pages
                        </a>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                        <a href="<?php echo e(route('admin.landing_page.submitted_form_data')); ?>"
                            class="nav-link <?php echo e(Route::is('admin.landing_page.submitted_form_data') ? 'active' : ''); ?>">
                            <i class="fa fa-caret-right mr-2" aria-hidden="true"></i>
                            Manage Form Data
                        </a>
                    </li>
        ...
        ?>
        <li class="nav-item <?php echo e($is_active_founder ? 'active' : ''); ?>">
            <a class="nav-link" href="<?php echo e(route('admin.founder.index')); ?>">
                <i class="fa fa-users menu-icon"></i>
...
<?php /**PATH C:\laragon\www\rminternational-20241015\resources\views/Backend/components/sidebar.blade.php ENDPATH**/ ?>