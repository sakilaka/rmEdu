                            ...
                            <div class="col-12 mt-2">
                                <div class="form-label-group mt-2">
                                    <select class="custom-select d-block w-100" id="fund" name="fund" placeholder="How do you plan to fund your studies level" value="0" required="">
                                        <option <?php if($application->study_fund == "Self finance"): ?> selected <?php endif; ?> value="Self finance">Self finance</option>
                                        
                                        <option <?php if($application->study_fund == "Part scholarship part self financed"): ?> selected <?php endif; ?> value="Part scholarship part self financed">Part scholarship part self
...
<?php /**PATH /home/rmintern/public_html/resources/views/Frontend/university/apply-parts/family-panel.blade.php ENDPATH**/ ?>