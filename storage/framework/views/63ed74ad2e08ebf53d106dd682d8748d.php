...
<head>
    ...
    <title><?php echo e(env('APP_NAME')); ?> | Student Application Document Edit</title>
</head>
...
<body>
                            ...
                            <div class="tab-content tab-content-vertical bg-white rounded">
                                <div class="tab-pane fade show active" id="program-info-tab-content" role="tabpanel"
                                    ...
                                    <form novalidate="" method="post"
                                        action="<?php echo e(route('admin.student_appliction_document-update', $s_appliction->id)); ?>"
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label class="font-weight-bold text-muted">
                                                            ...
                                                            <?php echo e(__($document->document_name)); ?>

                                                        </label>
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <input type="file" class="mt-3 mb-3 form-control"
                                                                    name="old_document_file[<?php echo e($document->id); ?>]"
                                                                    value="<?php echo e($document->document_file); ?>" />
                                                            </div>
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="audioModalLabel"
                                                                    style="color: black"><?php echo e($document->document_name); ?>
    ...
    <script>
        var student_app_id = "<?php echo e($s_appliction->id); ?>";
        var current_order = "<?php echo e($s_appliction->documents->count()); ?>";
        ...
        $("#uploadFile").on("click", function(e) {
            ...
            if ($("#uploadForm")[0].checkValidity()) {
                ...
                var url = "<?php echo e(url('/add-attachment/upload/')); ?>/" + student_app_id;
...
<?php /**PATH C:\laragon\www\rminternational-20241015\resources\views/Backend/student_appliction/edit_document_info.blade.php ENDPATH**/ ?>