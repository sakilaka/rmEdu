                    ...
                    <div class="row mx-0 align-items-center border-md rounded-3">
                        <div class="col-md-6 border-end-md p-4 p-sm-5">
                            ...
                            <div class="mt-sm-2 mb-sm-4 text-center">
                                Login as <strong>
                                    <a href="<?php echo e(route('frontend.consultant_signin')); ?>"
                        ...
                        <div class="col-md-6 px-4 pt-2 pb-4 px-sm-5 pb-sm-5 pt-md-5">
                            ...
                            <form action="<?php echo e(route('frontend.sign_in')); ?>" class="myform" id="learner_myform"
                            ...
                            <div class="mt-sm-4 text-center">
                                Don't have an account? <strong>
                                    ...
                                    <a href="<?php echo e(route('frontend.register')); ?>" class="text-decoration-underline">Create an
                                        Account</a> </strong>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('Frontend.layouts.master-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\rminternational-20241015\resources\views/Frontend/auth/login.blade.php ENDPATH**/ ?>